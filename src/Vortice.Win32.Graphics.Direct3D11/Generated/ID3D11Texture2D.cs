...
public unsafe partial struct ID3D11Texture2D : ID3D11Texture2D.Interface, INativeGuid
{
	...
	{
		((delegate* unmanaged[MemberFunction]<ID3D11Texture2D*, ID3D11Device**, void>)(lpVtbl[3]))((ID3D11Texture2D*)Unsafe.AsPointer(ref this), ppDevice);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID3D11Texture2D*, ResourceDimension*, void>)(lpVtbl[7]))((ID3D11Texture2D*)Unsafe.AsPointer(ref this), pResourceDimension);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID3D11Texture2D*, uint, void>)(lpVtbl[8]))((ID3D11Texture2D*)Unsafe.AsPointer(ref this), EvictionPriority);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D11Texture2D*, uint>)(lpVtbl[9]))((ID3D11Texture2D*)Unsafe.AsPointer(ref this));
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID3D11Texture2D*, Texture2DDescription*, void>)(lpVtbl[10]))((ID3D11Texture2D*)Unsafe.AsPointer(ref this), pDesc);
	}
