...
public unsafe partial struct ID3D11DeviceContext2 : ID3D11DeviceContext2.Interface, INativeGuid
{
	...
	{
		((delegate* unmanaged[MemberFunction]<ID3D11DeviceContext2*, ID3D11Predicate*, Bool32, void>)(lpVtbl[30]))((ID3D11DeviceContext2*)Unsafe.AsPointer(ref this), pPredicate, PredicateValue);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID3D11DeviceContext2*, ID3D11CommandList*, Bool32, void>)(lpVtbl[58]))((ID3D11DeviceContext2*)Unsafe.AsPointer(ref this), pCommandList, RestoreContextState);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID3D11DeviceContext2*, ID3D11Predicate**, Bool32*, void>)(lpVtbl[86]))((ID3D11DeviceContext2*)Unsafe.AsPointer(ref this), ppPredicate, pPredicateValue);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D11DeviceContext2*, Bool32, ID3D11CommandList**, int>)(lpVtbl[114]))((ID3D11DeviceContext2*)Unsafe.AsPointer(ref this), RestoreDeferredContextState, ppCommandList);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D11DeviceContext2*, Bool32>)(lpVtbl[140]))((ID3D11DeviceContext2*)Unsafe.AsPointer(ref this));
	}
