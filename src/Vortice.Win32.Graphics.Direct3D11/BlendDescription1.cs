...
public partial struct BlendDescription1
{
    ...
    /// </summary>
    public static BlendDescription1 AlphaBlend => new(Blend.One, Blend.InverseSrcAlpha);
    ...
    /// </summary>
    public static BlendDescription1 Additive => new(Blend.SrcAlpha, Blend.One);
    ...
    /// </summary>
    public static BlendDescription1 NonPremultiplied => new(Blend.SrcAlpha, Blend.InverseSrcAlpha);
