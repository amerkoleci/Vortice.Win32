...
public unsafe partial struct IDWriteFontSet1 : IDWriteFontSet1.Interface, INativeGuid
{
	...
	{
		return ((delegate* unmanaged[MemberFunction]<IDWriteFontSet1*, Guid*, void**, int>)(lpVtbl[0]))((IDWriteFontSet1*)Unsafe.AsPointer(ref this), riid, ppvObject);
	}
	...
	public uint AddRef()
	{
		return ((delegate* unmanaged[MemberFunction]<IDWriteFontSet1*, uint>)(lpVtbl[1]))((IDWriteFontSet1*)Unsafe.AsPointer(ref this));
	}
	...
	public uint Release()
	{
		return ((delegate* unmanaged[MemberFunction]<IDWriteFontSet1*, uint>)(lpVtbl[2]))((IDWriteFontSet1*)Unsafe.AsPointer(ref this));
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<IDWriteFontSet1*, uint>)(lpVtbl[3]))((IDWriteFontSet1*)Unsafe.AsPointer(ref this));
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<IDWriteFontSet1*, uint, IDWriteFontFaceReference**, int>)(lpVtbl[4]))((IDWriteFontSet1*)Unsafe.AsPointer(ref this), listIndex, fontFaceReference);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<IDWriteFontSet1*, IDWriteFontFaceReference*, uint*, Bool32*, int>)(lpVtbl[5]))((IDWriteFontSet1*)Unsafe.AsPointer(ref this), fontFaceReference, listIndex, exists);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<IDWriteFontSet1*, IDWriteFontFace*, uint*, Bool32*, int>)(lpVtbl[6]))((IDWriteFontSet1*)Unsafe.AsPointer(ref this), fontFace, listIndex, exists);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<IDWriteFontSet1*, IDWriteFontSet1**, int>)(lpVtbl[14]))((IDWriteFontSet1*)Unsafe.AsPointer(ref this), filteredFontSet);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<IDWriteFontSet1*, uint*, uint, IDWriteFontSet1**, int>)(lpVtbl[15]))((IDWriteFontSet1*)Unsafe.AsPointer(ref this), indices, indexCount, filteredFontSet);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<IDWriteFontSet1*, uint, IDWriteFontFaceReference1**, int>)(lpVtbl[22]))((IDWriteFontSet1*)Unsafe.AsPointer(ref this), listIndex, fontFaceReference);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<IDWriteFontSet1*, uint, IDWriteFontResource**, int>)(lpVtbl[23]))((IDWriteFontSet1*)Unsafe.AsPointer(ref this), listIndex, fontResource);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<IDWriteFontSet1*, uint, IDWriteFontFace5**, int>)(lpVtbl[24]))((IDWriteFontSet1*)Unsafe.AsPointer(ref this), listIndex, fontFace);
	}
