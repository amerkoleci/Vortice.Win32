...
public unsafe partial struct IDWriteFactory2 : IDWriteFactory2.Interface, INativeGuid
{
	...
	{
		return ((delegate* unmanaged[MemberFunction]<IDWriteFactory2*, IDWriteFontCollection**, Bool32, int>)(lpVtbl[3]))((IDWriteFactory2*)Unsafe.AsPointer(ref this), fontCollection, checkForUpdates);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<IDWriteFactory2*, ushort*, ulong*, IDWriteFontFile**, int>)(lpVtbl[7]))((IDWriteFactory2*)Unsafe.AsPointer(ref this), filePath, lastWriteTime, fontFile);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<IDWriteFactory2*, IntPtr, IDWriteRenderingParams**, int>)(lpVtbl[11]))((IDWriteFactory2*)Unsafe.AsPointer(ref this), monitor, renderingParams);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<IDWriteFactory2*, ushort*, IDWriteFontCollection*, FontWeight, FontStyle, FontStretch, float, ushort*, IDWriteTextFormat**, int>)(lpVtbl[15]))((IDWriteFactory2*)Unsafe.AsPointer(ref this), fontFamilyName, fontCollection, fontWeight, fontStyle, fontStretch, fontSize, localeName, textFormat);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<IDWriteFactory2*, ushort*, uint, IDWriteTextFormat*, float, float, IDWriteTextLayout**, int>)(lpVtbl[18]))((IDWriteFactory2*)Unsafe.AsPointer(ref this), @string, stringLength, textFormat, maxWidth, maxHeight, textLayout);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<IDWriteFactory2*, ushort*, uint, IDWriteTextFormat*, float, float, float, Matrix3x2*, Bool32, IDWriteTextLayout**, int>)(lpVtbl[19]))((IDWriteFactory2*)Unsafe.AsPointer(ref this), @string, stringLength, textFormat, layoutWidth, layoutHeight, pixelsPerDip, transform, useGdiNatural, textLayout);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<IDWriteFactory2*, NumberSubstitutionMethod, ushort*, Bool32, IDWriteNumberSubstitution**, int>)(lpVtbl[22]))((IDWriteFactory2*)Unsafe.AsPointer(ref this), substitutionMethod, localeName, ignoreUserOverride, numberSubstitution);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<IDWriteFactory2*, IDWriteFontCollection**, Bool32, int>)(lpVtbl[24]))((IDWriteFactory2*)Unsafe.AsPointer(ref this), fontCollection, checkForUpdates);
	}
