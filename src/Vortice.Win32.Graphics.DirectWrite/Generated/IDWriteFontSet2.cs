...
public unsafe partial struct IDWriteFontSet2 : IDWriteFontSet2.Interface, INativeGuid
{
	...
	{
#if NET6_0_OR_GREATER
		return ((delegate* unmanaged<IDWriteFontSet2*, IDWriteFontFaceReference*, uint*, Bool32*, int>)(lpVtbl[5]))((IDWriteFontSet2*)Unsafe.AsPointer(ref this), fontFaceReference, listIndex, exists);
#else
	...
	{
#if NET6_0_OR_GREATER
		return ((delegate* unmanaged<IDWriteFontSet2*, IDWriteFontFace*, uint*, Bool32*, int>)(lpVtbl[6]))((IDWriteFontSet2*)Unsafe.AsPointer(ref this), fontFace, listIndex, exists);
#else
	...
	{
#if NET6_0_OR_GREATER
		return ((delegate* unmanaged<IDWriteFontSet2*, FontPropertyId, IDWriteStringList**, int>)(lpVtbl[7]))((IDWriteFontSet2*)Unsafe.AsPointer(ref this), propertyID, values);
#else
	...
	{
#if NET6_0_OR_GREATER
		return ((delegate* unmanaged<IDWriteFontSet2*, FontPropertyId, ushort*, IDWriteStringList**, int>)(lpVtbl[8]))((IDWriteFontSet2*)Unsafe.AsPointer(ref this), propertyID, preferredLocaleNames, values);
#else
	...
	{
#if NET6_0_OR_GREATER
		return ((delegate* unmanaged<IDWriteFontSet2*, uint, FontPropertyId, Bool32*, IDWriteLocalizedStrings**, int>)(lpVtbl[9]))((IDWriteFontSet2*)Unsafe.AsPointer(ref this), listIndex, propertyId, exists, values);
#else
	...
	{
#if NET6_0_OR_GREATER
		return ((delegate* unmanaged<IDWriteFontSet2*, FontProperty*, uint*, int>)(lpVtbl[10]))((IDWriteFontSet2*)Unsafe.AsPointer(ref this), property, propertyOccurrenceCount);
#else
	...
	{
#if NET6_0_OR_GREATER
		return ((delegate* unmanaged<IDWriteFontSet2*, ushort*, FontWeight, FontStretch, FontStyle, IDWriteFontSet**, int>)(lpVtbl[11]))((IDWriteFontSet2*)Unsafe.AsPointer(ref this), familyName, fontWeight, fontStretch, fontStyle, filteredSet);
#else
	...
	{
#if NET6_0_OR_GREATER
		return ((delegate* unmanaged<IDWriteFontSet2*, FontProperty*, uint, IDWriteFontSet**, int>)(lpVtbl[12]))((IDWriteFontSet2*)Unsafe.AsPointer(ref this), properties, propertyCount, filteredSet);
#else
	...
	{
#if NET6_0_OR_GREATER
		return ((delegate* unmanaged<IDWriteFontSet2*, FontProperty*, FontAxisValue*, uint, IDWriteFontSet1**, int>)(lpVtbl[13]))((IDWriteFontSet2*)Unsafe.AsPointer(ref this), fontProperty, fontAxisValues, fontAxisValueCount, matchingFonts);
#else
	...
	{
#if NET6_0_OR_GREATER
		return ((delegate* unmanaged<IDWriteFontSet2*, FontAxisRange*, uint, Bool32, IDWriteFontSet1**, int>)(lpVtbl[16]))((IDWriteFontSet2*)Unsafe.AsPointer(ref this), fontAxisRanges, fontAxisRangeCount, selectAnyRange, filteredFontSet);
#else
	...
	{
#if NET6_0_OR_GREATER
		return ((delegate* unmanaged<IDWriteFontSet2*, FontProperty*, uint, Bool32, IDWriteFontSet1**, int>)(lpVtbl[17]))((IDWriteFontSet2*)Unsafe.AsPointer(ref this), properties, propertyCount, selectAnyProperty, filteredFontSet);
#else
	...
	{
#if NET6_0_OR_GREATER
		return ((delegate* unmanaged<IDWriteFontSet2*, FontAxisRange*, uint, Bool32, uint*, uint, uint*, int>)(lpVtbl[18]))((IDWriteFontSet2*)Unsafe.AsPointer(ref this), fontAxisRanges, fontAxisRangeCount, selectAnyRange, indices, maxIndexCount, actualIndexCount);
#else
	...
	{
#if NET6_0_OR_GREATER
		return ((delegate* unmanaged<IDWriteFontSet2*, FontProperty*, uint, Bool32, uint*, uint, uint*, int>)(lpVtbl[19]))((IDWriteFontSet2*)Unsafe.AsPointer(ref this), properties, propertyCount, selectAnyProperty, indices, maxIndexCount, actualIndexCount);
#else
	...
	{
#if NET6_0_OR_GREATER
		return ((delegate* unmanaged<IDWriteFontSet2*, uint, FontAxisRange*, uint, uint*, int>)(lpVtbl[20]))((IDWriteFontSet2*)Unsafe.AsPointer(ref this), listIndex, fontAxisRanges, maxFontAxisRangeCount, actualFontAxisRangeCount);
#else
	...
	{
#if NET6_0_OR_GREATER
		return ((delegate* unmanaged<IDWriteFontSet2*, FontAxisRange*, uint, uint*, int>)(lpVtbl[21]))((IDWriteFontSet2*)Unsafe.AsPointer(ref this), fontAxisRanges, maxFontAxisRangeCount, actualFontAxisRangeCount);
#else
	...
	{
#if NET6_0_OR_GREATER
		return ((delegate* unmanaged<IDWriteFontSet2*, uint, Locality>)(lpVtbl[25]))((IDWriteFontSet2*)Unsafe.AsPointer(ref this), listIndex);
#else
	...
	{
#if NET6_0_OR_GREATER
		return ((delegate* unmanaged<IDWriteFontSet2*, Handle>)(lpVtbl[26]))((IDWriteFontSet2*)Unsafe.AsPointer(ref this));
#else
