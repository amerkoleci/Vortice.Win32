...
public unsafe partial struct IDWriteFontFace7 : IDWriteFontFace7.Interface, INativeGuid
{
	...
	{
		return ((delegate* unmanaged[MemberFunction]<IDWriteFontFace7*, Guid*, void**, int>)(lpVtbl[0]))((IDWriteFontFace7*)Unsafe.AsPointer(ref this), riid, ppvObject);
	}
	...
	public uint AddRef()
	{
		return ((delegate* unmanaged[MemberFunction]<IDWriteFontFace7*, uint>)(lpVtbl[1]))((IDWriteFontFace7*)Unsafe.AsPointer(ref this));
	}
	...
	public uint Release()
	{
		return ((delegate* unmanaged[MemberFunction]<IDWriteFontFace7*, uint>)(lpVtbl[2]))((IDWriteFontFace7*)Unsafe.AsPointer(ref this));
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<IDWriteFontFace7*, uint*, IDWriteFontFile**, int>)(lpVtbl[4]))((IDWriteFontFace7*)Unsafe.AsPointer(ref this), numberOfFiles, fontFiles);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<IDWriteFontFace7*, uint>)(lpVtbl[5]))((IDWriteFontFace7*)Unsafe.AsPointer(ref this));
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<IDWriteFontFace7*, Bool32>)(lpVtbl[7]))((IDWriteFontFace7*)Unsafe.AsPointer(ref this));
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<IDWriteFontFace7*, ushort>)(lpVtbl[9]))((IDWriteFontFace7*)Unsafe.AsPointer(ref this));
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<IDWriteFontFace7*, uint*, uint, ushort*, int>)(lpVtbl[11]))((IDWriteFontFace7*)Unsafe.AsPointer(ref this), codePoints, codePointCount, glyphIndices);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<IDWriteFontFace7*, uint, void**, uint*, void**, Bool32*, int>)(lpVtbl[12]))((IDWriteFontFace7*)Unsafe.AsPointer(ref this), openTypeTableTag, tableData, tableSize, tableContext, exists);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<IDWriteFontFace7*, void*, void>)(lpVtbl[13]))((IDWriteFontFace7*)Unsafe.AsPointer(ref this), tableContext);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<IDWriteFontFace7*, Bool32>)(lpVtbl[22]))((IDWriteFontFace7*)Unsafe.AsPointer(ref this));
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<IDWriteFontFace7*, uint, ushort*, int*, Bool32, int>)(lpVtbl[23]))((IDWriteFontFace7*)Unsafe.AsPointer(ref this), glyphCount, glyphIndices, glyphAdvances, isSideways);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<IDWriteFontFace7*, float, float, Matrix3x2*, Bool32, Bool32, uint, ushort*, int*, int>)(lpVtbl[24]))((IDWriteFontFace7*)Unsafe.AsPointer(ref this), emSize, pixelsPerDip, transform, useGdiNatural, isSideways, glyphCount, glyphIndices, glyphAdvances);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<IDWriteFontFace7*, uint, ushort*, int*, int>)(lpVtbl[25]))((IDWriteFontFace7*)Unsafe.AsPointer(ref this), glyphCount, glyphIndices, glyphAdvanceAdjustments);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<IDWriteFontFace7*, Bool32>)(lpVtbl[26]))((IDWriteFontFace7*)Unsafe.AsPointer(ref this));
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<IDWriteFontFace7*, uint, ushort*, ushort*, int>)(lpVtbl[28]))((IDWriteFontFace7*)Unsafe.AsPointer(ref this), glyphCount, nominalGlyphIndices, verticalGlyphIndices);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<IDWriteFontFace7*, Bool32>)(lpVtbl[29]))((IDWriteFontFace7*)Unsafe.AsPointer(ref this));
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<IDWriteFontFace7*, Bool32>)(lpVtbl[30]))((IDWriteFontFace7*)Unsafe.AsPointer(ref this));
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<IDWriteFontFace7*, uint>)(lpVtbl[31]))((IDWriteFontFace7*)Unsafe.AsPointer(ref this));
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<IDWriteFontFace7*, uint>)(lpVtbl[32]))((IDWriteFontFace7*)Unsafe.AsPointer(ref this));
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<IDWriteFontFace7*, uint, uint, uint, Color4**, int>)(lpVtbl[33]))((IDWriteFontFace7*)Unsafe.AsPointer(ref this), colorPaletteIndex, firstEntryIndex, entryCount, paletteEntries);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<IDWriteFontFace7*, IDWriteFontFaceReference**, int>)(lpVtbl[35]))((IDWriteFontFace7*)Unsafe.AsPointer(ref this), fontFaceReference);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<IDWriteFontFace7*, IDWriteLocalizedStrings**, int>)(lpVtbl[40]))((IDWriteFontFace7*)Unsafe.AsPointer(ref this), names);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<IDWriteFontFace7*, IDWriteLocalizedStrings**, int>)(lpVtbl[41]))((IDWriteFontFace7*)Unsafe.AsPointer(ref this), names);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<IDWriteFontFace7*, uint, Bool32>)(lpVtbl[43]))((IDWriteFontFace7*)Unsafe.AsPointer(ref this), unicodeValue);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<IDWriteFontFace7*, uint, Bool32>)(lpVtbl[45]))((IDWriteFontFace7*)Unsafe.AsPointer(ref this), unicodeValue);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<IDWriteFontFace7*, ushort, Bool32>)(lpVtbl[46]))((IDWriteFontFace7*)Unsafe.AsPointer(ref this), glyphId);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<IDWriteFontFace7*, char*, uint, Bool32, Bool32*, int>)(lpVtbl[47]))((IDWriteFontFace7*)Unsafe.AsPointer(ref this), characters, characterCount, enqueueIfNotLocal, isLocal);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<IDWriteFontFace7*, ushort*, uint, Bool32, Bool32*, int>)(lpVtbl[48]))((IDWriteFontFace7*)Unsafe.AsPointer(ref this), glyphIndices, glyphCount, enqueueIfNotLocal, isLocal);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<IDWriteFontFace7*, void*, void>)(lpVtbl[52]))((IDWriteFontFace7*)Unsafe.AsPointer(ref this), glyphDataContext);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<IDWriteFontFace7*, uint>)(lpVtbl[53]))((IDWriteFontFace7*)Unsafe.AsPointer(ref this));
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<IDWriteFontFace7*, Bool32>)(lpVtbl[55]))((IDWriteFontFace7*)Unsafe.AsPointer(ref this));
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<IDWriteFontFace7*, IDWriteFontResource**, int>)(lpVtbl[56]))((IDWriteFontFace7*)Unsafe.AsPointer(ref this), fontResource);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<IDWriteFontFace7*, IDWriteFontFace*, Bool32>)(lpVtbl[57]))((IDWriteFontFace7*)Unsafe.AsPointer(ref this), fontFace);
	}
