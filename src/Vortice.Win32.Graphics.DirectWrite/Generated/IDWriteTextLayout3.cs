...
public unsafe partial struct IDWriteTextLayout3 : IDWriteTextLayout3.Interface, INativeGuid
{
	...
	{
		return ((delegate* unmanaged[MemberFunction]<IDWriteTextLayout3*, ushort*, uint, int>)(lpVtbl[21]))((IDWriteTextLayout3*)Unsafe.AsPointer(ref this), fontFamilyName, nameSize);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<IDWriteTextLayout3*, ushort*, uint, int>)(lpVtbl[27]))((IDWriteTextLayout3*)Unsafe.AsPointer(ref this), localeName, nameSize);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<IDWriteTextLayout3*, uint, ushort*, uint, TextRange*, int>)(lpVtbl[46]))((IDWriteTextLayout3*)Unsafe.AsPointer(ref this), currentPosition, fontFamilyName, nameSize, textRange);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<IDWriteTextLayout3*, uint, ushort*, uint, TextRange*, int>)(lpVtbl[57]))((IDWriteTextLayout3*)Unsafe.AsPointer(ref this), currentPosition, localeName, nameSize, textRange);
	}
