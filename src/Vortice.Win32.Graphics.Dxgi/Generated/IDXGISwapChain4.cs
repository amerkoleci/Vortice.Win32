...
public unsafe partial struct IDXGISwapChain4 : IDXGISwapChain4.Interface, INativeGuid
{
	...
	{
		return ((delegate* unmanaged[MemberFunction]<IDXGISwapChain4*, Guid*, void**, int>)(lpVtbl[0]))((IDXGISwapChain4*)Unsafe.AsPointer(ref this), riid, ppvObject);
	}
	...
	public uint AddRef()
	{
		return ((delegate* unmanaged[MemberFunction]<IDXGISwapChain4*, uint>)(lpVtbl[1]))((IDXGISwapChain4*)Unsafe.AsPointer(ref this));
	}
	...
	public uint Release()
	{
		return ((delegate* unmanaged[MemberFunction]<IDXGISwapChain4*, uint>)(lpVtbl[2]))((IDXGISwapChain4*)Unsafe.AsPointer(ref this));
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<IDXGISwapChain4*, Guid*, uint, void*, int>)(lpVtbl[3]))((IDXGISwapChain4*)Unsafe.AsPointer(ref this), Name, DataSize, pData);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<IDXGISwapChain4*, Guid*, IUnknown*, int>)(lpVtbl[4]))((IDXGISwapChain4*)Unsafe.AsPointer(ref this), Name, pUnknown);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<IDXGISwapChain4*, Guid*, uint*, void*, int>)(lpVtbl[5]))((IDXGISwapChain4*)Unsafe.AsPointer(ref this), Name, pDataSize, pData);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<IDXGISwapChain4*, Guid*, void**, int>)(lpVtbl[6]))((IDXGISwapChain4*)Unsafe.AsPointer(ref this), riid, ppParent);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<IDXGISwapChain4*, Guid*, void**, int>)(lpVtbl[7]))((IDXGISwapChain4*)Unsafe.AsPointer(ref this), riid, ppDevice);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<IDXGISwapChain4*, uint, Guid*, void**, int>)(lpVtbl[9]))((IDXGISwapChain4*)Unsafe.AsPointer(ref this), Buffer, riid, ppSurface);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<IDXGISwapChain4*, Bool32, IDXGIOutput*, int>)(lpVtbl[10]))((IDXGISwapChain4*)Unsafe.AsPointer(ref this), Fullscreen, pTarget);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<IDXGISwapChain4*, Bool32*, IDXGIOutput**, int>)(lpVtbl[11]))((IDXGISwapChain4*)Unsafe.AsPointer(ref this), pFullscreen, ppTarget);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<IDXGISwapChain4*, IDXGIOutput**, int>)(lpVtbl[15]))((IDXGISwapChain4*)Unsafe.AsPointer(ref this), ppOutput);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<IDXGISwapChain4*, uint*, int>)(lpVtbl[17]))((IDXGISwapChain4*)Unsafe.AsPointer(ref this), pLastPresentCount);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<IDXGISwapChain4*, nint*, int>)(lpVtbl[20]))((IDXGISwapChain4*)Unsafe.AsPointer(ref this), pHwnd);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<IDXGISwapChain4*, Guid*, void**, int>)(lpVtbl[21]))((IDXGISwapChain4*)Unsafe.AsPointer(ref this), refiid, ppUnk);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<IDXGISwapChain4*, uint, uint, PresentParameters*, int>)(lpVtbl[22]))((IDXGISwapChain4*)Unsafe.AsPointer(ref this), SyncInterval, PresentFlags, pPresentParameters);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<IDXGISwapChain4*, Bool32>)(lpVtbl[23]))((IDXGISwapChain4*)Unsafe.AsPointer(ref this));
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<IDXGISwapChain4*, IDXGIOutput**, int>)(lpVtbl[24]))((IDXGISwapChain4*)Unsafe.AsPointer(ref this), ppRestrictToOutput);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<IDXGISwapChain4*, Color4*, int>)(lpVtbl[25]))((IDXGISwapChain4*)Unsafe.AsPointer(ref this), pColor);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<IDXGISwapChain4*, Color4**, int>)(lpVtbl[26]))((IDXGISwapChain4*)Unsafe.AsPointer(ref this), pColor);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<IDXGISwapChain4*, uint, uint, int>)(lpVtbl[29]))((IDXGISwapChain4*)Unsafe.AsPointer(ref this), Width, Height);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<IDXGISwapChain4*, uint*, uint*, int>)(lpVtbl[30]))((IDXGISwapChain4*)Unsafe.AsPointer(ref this), pWidth, pHeight);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<IDXGISwapChain4*, uint, int>)(lpVtbl[31]))((IDXGISwapChain4*)Unsafe.AsPointer(ref this), MaxLatency);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<IDXGISwapChain4*, uint*, int>)(lpVtbl[32]))((IDXGISwapChain4*)Unsafe.AsPointer(ref this), pMaxLatency);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<IDXGISwapChain4*, Handle>)(lpVtbl[33]))((IDXGISwapChain4*)Unsafe.AsPointer(ref this));
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<IDXGISwapChain4*, Matrix3x2*, int>)(lpVtbl[34]))((IDXGISwapChain4*)Unsafe.AsPointer(ref this), pMatrix);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<IDXGISwapChain4*, Matrix3x2*, int>)(lpVtbl[35]))((IDXGISwapChain4*)Unsafe.AsPointer(ref this), pMatrix);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<IDXGISwapChain4*, uint>)(lpVtbl[36]))((IDXGISwapChain4*)Unsafe.AsPointer(ref this));
	}
