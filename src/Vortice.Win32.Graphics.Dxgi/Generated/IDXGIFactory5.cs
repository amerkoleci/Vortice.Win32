...
public unsafe partial struct IDXGIFactory5 : IDXGIFactory5.Interface, INativeGuid
{
	...
	{
		return ((delegate* unmanaged[MemberFunction]<IDXGIFactory5*, nint*, int>)(lpVtbl[9]))((IDXGIFactory5*)Unsafe.AsPointer(ref this), pWindowHandle);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<IDXGIFactory5*, nint, IDXGIAdapter**, int>)(lpVtbl[11]))((IDXGIFactory5*)Unsafe.AsPointer(ref this), Module, ppAdapter);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<IDXGIFactory5*, Bool32>)(lpVtbl[13]))((IDXGIFactory5*)Unsafe.AsPointer(ref this));
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<IDXGIFactory5*, Bool32>)(lpVtbl[14]))((IDXGIFactory5*)Unsafe.AsPointer(ref this));
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<IDXGIFactory5*, nint, uint, uint*, int>)(lpVtbl[18]))((IDXGIFactory5*)Unsafe.AsPointer(ref this), WindowHandle, wMsg, pdwCookie);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<IDXGIFactory5*, nint, uint, uint*, int>)(lpVtbl[21]))((IDXGIFactory5*)Unsafe.AsPointer(ref this), WindowHandle, wMsg, pdwCookie);
	}
