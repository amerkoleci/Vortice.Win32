...
public unsafe partial struct ID3D12ProtectedResourceSession : ID3D12ProtectedResourceSession.Interface, INativeGuid
{
...
#else
		return ((delegate* unmanaged[Stdcall]<ID3D12ProtectedResourceSession*, Guid*, void**, int>)(lpVtbl[0]))((ID3D12ProtectedResourceSession*)Unsafe.AsPointer(ref this), riid, ppvObject);
#endif
	}
...
#else
		return ((delegate* unmanaged[Stdcall]<ID3D12ProtectedResourceSession*, uint>)(lpVtbl[1]))((ID3D12ProtectedResourceSession*)Unsafe.AsPointer(ref this));
#endif
	}
...
#else
		return ((delegate* unmanaged[Stdcall]<ID3D12ProtectedResourceSession*, uint>)(lpVtbl[2]))((ID3D12ProtectedResourceSession*)Unsafe.AsPointer(ref this));
#endif
	}
	...
	{
#if NET6_0_OR_GREATER
		return ((delegate* unmanaged<ID3D12ProtectedResourceSession*, ProtectedSessionStatus>)(lpVtbl[9]))((ID3D12ProtectedResourceSession*)Unsafe.AsPointer(ref this));
#else
...
#if NET6_0_OR_GREATER
		return *((delegate* unmanaged<ID3D12ProtectedResourceSession*, ProtectedResourceSessionDescription*, ProtectedResourceSessionDescription*>)(lpVtbl[10]))((ID3D12ProtectedResourceSession*)Unsafe.AsPointer(ref this), &result);
#else
