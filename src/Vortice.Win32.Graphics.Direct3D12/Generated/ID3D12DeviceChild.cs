...
public unsafe partial struct ID3D12DeviceChild : ID3D12DeviceChild.Interface, INativeGuid
{
	...
	public uint AddRef()
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12DeviceChild*, uint>)(lpVtbl[1]))((ID3D12DeviceChild*)Unsafe.AsPointer(ref this));
	}
	...
	public uint Release()
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12DeviceChild*, uint>)(lpVtbl[2]))((ID3D12DeviceChild*)Unsafe.AsPointer(ref this));
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12DeviceChild*, ushort*, int>)(lpVtbl[6]))((ID3D12DeviceChild*)Unsafe.AsPointer(ref this), Name);
	}
