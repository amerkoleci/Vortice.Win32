...
public unsafe partial struct ID3D12Device6 : ID3D12Device6.Interface, INativeGuid
{
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device6*, ID3D12DeviceChild*, Security.SECURITY_ATTRIBUTES*, uint, char*, Handle*, int>)(lpVtbl[31]))((ID3D12Device6*)Unsafe.AsPointer(ref this), pObject, pAttributes, Access, Name, pHandle);
	}
