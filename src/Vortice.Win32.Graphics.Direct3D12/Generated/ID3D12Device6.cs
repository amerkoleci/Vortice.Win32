...
public unsafe partial struct ID3D12Device6 : ID3D12Device6.Interface, INativeGuid
{
	...
	{
#if NET6_0_OR_GREATER
		return ((delegate* unmanaged<ID3D12Device6*, CommandQueueDescription*, Guid*, void**, int>)(lpVtbl[8]))((ID3D12Device6*)Unsafe.AsPointer(ref this), pDesc, riid, ppCommandQueue);
#else
	...
	{
#if NET6_0_OR_GREATER
		return ((delegate* unmanaged<ID3D12Device6*, CommandListType, Guid*, void**, int>)(lpVtbl[9]))((ID3D12Device6*)Unsafe.AsPointer(ref this), type, riid, ppCommandAllocator);
#else
	...
	{
#if NET6_0_OR_GREATER
		return ((delegate* unmanaged<ID3D12Device6*, GraphicsPipelineStateDescription*, Guid*, void**, int>)(lpVtbl[10]))((ID3D12Device6*)Unsafe.AsPointer(ref this), pDesc, riid, ppPipelineState);
#else
	...
	{
#if NET6_0_OR_GREATER
		return ((delegate* unmanaged<ID3D12Device6*, ComputePipelineStateDescription*, Guid*, void**, int>)(lpVtbl[11]))((ID3D12Device6*)Unsafe.AsPointer(ref this), pDesc, riid, ppPipelineState);
#else
	...
	{
#if NET6_0_OR_GREATER
		return ((delegate* unmanaged<ID3D12Device6*, uint, CommandListType, ID3D12CommandAllocator*, ID3D12PipelineState*, Guid*, void**, int>)(lpVtbl[12]))((ID3D12Device6*)Unsafe.AsPointer(ref this), nodeMask, type, pCommandAllocator, pInitialState, riid, ppCommandList);
#else
	...
	{
#if NET6_0_OR_GREATER
		return ((delegate* unmanaged<ID3D12Device6*, Feature, void*, int, int>)(lpVtbl[13]))((ID3D12Device6*)Unsafe.AsPointer(ref this), Feature, pFeatureSupportData, FeatureSupportDataSize);
#else
	...
	{
#if NET6_0_OR_GREATER
		return ((delegate* unmanaged<ID3D12Device6*, DescriptorHeapDescription*, Guid*, void**, int>)(lpVtbl[14]))((ID3D12Device6*)Unsafe.AsPointer(ref this), pDescriptorHeapDesc, riid, ppvHeap);
#else
	...
	{
#if NET6_0_OR_GREATER
		return ((delegate* unmanaged<ID3D12Device6*, DescriptorHeapType, uint>)(lpVtbl[15]))((ID3D12Device6*)Unsafe.AsPointer(ref this), DescriptorHeapType);
#else
	...
	{
#if NET6_0_OR_GREATER
		((delegate* unmanaged<ID3D12Device6*, ConstantBufferViewDescription*, CpuDescriptorHandle, void>)(lpVtbl[17]))((ID3D12Device6*)Unsafe.AsPointer(ref this), pDesc, DestDescriptor);
#else
	...
	{
#if NET6_0_OR_GREATER
		((delegate* unmanaged<ID3D12Device6*, ID3D12Resource*, ShaderResourceViewDescription*, CpuDescriptorHandle, void>)(lpVtbl[18]))((ID3D12Device6*)Unsafe.AsPointer(ref this), pResource, pDesc, DestDescriptor);
#else
	...
	{
#if NET6_0_OR_GREATER
		((delegate* unmanaged<ID3D12Device6*, ID3D12Resource*, ID3D12Resource*, UnorderedAccessViewDescription*, CpuDescriptorHandle, void>)(lpVtbl[19]))((ID3D12Device6*)Unsafe.AsPointer(ref this), pResource, pCounterResource, pDesc, DestDescriptor);
#else
	...
	{
#if NET6_0_OR_GREATER
		((delegate* unmanaged<ID3D12Device6*, ID3D12Resource*, RenderTargetViewDescription*, CpuDescriptorHandle, void>)(lpVtbl[20]))((ID3D12Device6*)Unsafe.AsPointer(ref this), pResource, pDesc, DestDescriptor);
#else
	...
	{
#if NET6_0_OR_GREATER
		((delegate* unmanaged<ID3D12Device6*, ID3D12Resource*, DepthStencilViewDescription*, CpuDescriptorHandle, void>)(lpVtbl[21]))((ID3D12Device6*)Unsafe.AsPointer(ref this), pResource, pDesc, DestDescriptor);
#else
	...
	{
#if NET6_0_OR_GREATER
		((delegate* unmanaged<ID3D12Device6*, SamplerDescription*, CpuDescriptorHandle, void>)(lpVtbl[22]))((ID3D12Device6*)Unsafe.AsPointer(ref this), pDesc, DestDescriptor);
#else
	...
	{
#if NET6_0_OR_GREATER
		((delegate* unmanaged<ID3D12Device6*, uint, CpuDescriptorHandle*, uint*, uint, CpuDescriptorHandle*, uint*, DescriptorHeapType, void>)(lpVtbl[23]))((ID3D12Device6*)Unsafe.AsPointer(ref this), NumDestDescriptorRanges, pDestDescriptorRangeStarts, pDestDescriptorRangeSizes, NumSrcDescriptorRanges, pSrcDescriptorRangeStarts, pSrcDescriptorRangeSizes, DescriptorHeapsType);
#else
	...
	{
#if NET6_0_OR_GREATER
		((delegate* unmanaged<ID3D12Device6*, uint, CpuDescriptorHandle, CpuDescriptorHandle, DescriptorHeapType, void>)(lpVtbl[24]))((ID3D12Device6*)Unsafe.AsPointer(ref this), NumDescriptors, DestDescriptorRangeStart, SrcDescriptorRangeStart, DescriptorHeapsType);
#else
...
#if NET6_0_OR_GREATER
		return *((delegate* unmanaged<ID3D12Device6*, ResourceAllocationInfo*, uint, uint, ResourceDescription*, ResourceAllocationInfo*>)(lpVtbl[25]))((ID3D12Device6*)Unsafe.AsPointer(ref this), &result, visibleMask, numResourceDescs, pResourceDescs);
#else
...
#if NET6_0_OR_GREATER
		return *((delegate* unmanaged<ID3D12Device6*, HeapProperties*, uint, HeapType, HeapProperties*>)(lpVtbl[26]))((ID3D12Device6*)Unsafe.AsPointer(ref this), &result, nodeMask, heapType);
#else
	...
	{
#if NET6_0_OR_GREATER
		return ((delegate* unmanaged<ID3D12Device6*, HeapProperties*, HeapFlags, ResourceDescription*, ResourceStates, ClearValue*, Guid*, void**, int>)(lpVtbl[27]))((ID3D12Device6*)Unsafe.AsPointer(ref this), pHeapProperties, HeapFlags, pDesc, InitialResourceState, pOptimizedClearValue, riidResource, ppvResource);
#else
	...
	{
#if NET6_0_OR_GREATER
		return ((delegate* unmanaged<ID3D12Device6*, HeapDescription*, Guid*, void**, int>)(lpVtbl[28]))((ID3D12Device6*)Unsafe.AsPointer(ref this), pDesc, riid, ppvHeap);
#else
	...
	{
#if NET6_0_OR_GREATER
		return ((delegate* unmanaged<ID3D12Device6*, ID3D12Heap*, ulong, ResourceDescription*, ResourceStates, ClearValue*, Guid*, void**, int>)(lpVtbl[29]))((ID3D12Device6*)Unsafe.AsPointer(ref this), pHeap, HeapOffset, pDesc, InitialState, pOptimizedClearValue, riid, ppvResource);
#else
	...
	{
#if NET6_0_OR_GREATER
		return ((delegate* unmanaged<ID3D12Device6*, ResourceDescription*, ResourceStates, ClearValue*, Guid*, void**, int>)(lpVtbl[30]))((ID3D12Device6*)Unsafe.AsPointer(ref this), pDesc, InitialState, pOptimizedClearValue, riid, ppvResource);
#else
	...
	{
#if NET6_0_OR_GREATER
		return ((delegate* unmanaged<ID3D12Device6*, ID3D12DeviceChild*, Security.SECURITY_ATTRIBUTES*, uint, ushort*, Handle*, int>)(lpVtbl[31]))((ID3D12Device6*)Unsafe.AsPointer(ref this), pObject, pAttributes, Access, Name, pHandle);
#else
	...
	{
#if NET6_0_OR_GREATER
		return ((delegate* unmanaged<ID3D12Device6*, ulong, FenceFlags, Guid*, void**, int>)(lpVtbl[36]))((ID3D12Device6*)Unsafe.AsPointer(ref this), InitialValue, Flags, riid, ppFence);
#else
	...
	{
#if NET6_0_OR_GREATER
		((delegate* unmanaged<ID3D12Device6*, ResourceDescription*, uint, uint, ulong, PlacedSubresourceFootprint*, uint*, ulong*, ulong*, void>)(lpVtbl[38]))((ID3D12Device6*)Unsafe.AsPointer(ref this), pResourceDesc, FirstSubresource, NumSubresources, BaseOffset, pLayouts, pNumRows, pRowSizeInBytes, pTotalBytes);
#else
	...
	{
#if NET6_0_OR_GREATER
		return ((delegate* unmanaged<ID3D12Device6*, QueryHeapDescription*, Guid*, void**, int>)(lpVtbl[39]))((ID3D12Device6*)Unsafe.AsPointer(ref this), pDesc, riid, ppvHeap);
#else
	...
	{
#if NET6_0_OR_GREATER
		return ((delegate* unmanaged<ID3D12Device6*, Bool32, int>)(lpVtbl[40]))((ID3D12Device6*)Unsafe.AsPointer(ref this), Enable);
#else
	...
	{
#if NET6_0_OR_GREATER
		return ((delegate* unmanaged<ID3D12Device6*, CommandSignatureDescription*, ID3D12RootSignature*, Guid*, void**, int>)(lpVtbl[41]))((ID3D12Device6*)Unsafe.AsPointer(ref this), pDesc, pRootSignature, riid, ppvCommandSignature);
#else
	...
	{
#if NET6_0_OR_GREATER
		return ((delegate* unmanaged<ID3D12Device6*, ID3D12Fence**, ulong*, uint, MultipleFenceWaitFlags, Handle, int>)(lpVtbl[45]))((ID3D12Device6*)Unsafe.AsPointer(ref this), ppFences, pFenceValues, NumFences, Flags, hEvent);
#else
	...
	{
#if NET6_0_OR_GREATER
		return ((delegate* unmanaged<ID3D12Device6*, uint, ID3D12Pageable**, ResidencyPriority*, int>)(lpVtbl[46]))((ID3D12Device6*)Unsafe.AsPointer(ref this), NumObjects, ppObjects, pPriorities);
#else
	...
	{
#if NET6_0_OR_GREATER
		return ((delegate* unmanaged<ID3D12Device6*, PipelineStateStreamDescription*, Guid*, void**, int>)(lpVtbl[47]))((ID3D12Device6*)Unsafe.AsPointer(ref this), pDesc, riid, ppPipelineState);
#else
	...
	{
#if NET6_0_OR_GREATER
		return ((delegate* unmanaged<ID3D12Device6*, ResidencyFlags, uint, ID3D12Pageable**, ID3D12Fence*, ulong, int>)(lpVtbl[50]))((ID3D12Device6*)Unsafe.AsPointer(ref this), Flags, NumObjects, ppObjects, pFenceToSignal, FenceValueToSignal);
#else
	...
	{
#if NET6_0_OR_GREATER
		return ((delegate* unmanaged<ID3D12Device6*, uint, CommandListType, CommandListFlags, Guid*, void**, int>)(lpVtbl[51]))((ID3D12Device6*)Unsafe.AsPointer(ref this), nodeMask, type, flags, riid, ppCommandList);
#else
	...
	{
#if NET6_0_OR_GREATER
		return ((delegate* unmanaged<ID3D12Device6*, ProtectedResourceSessionDescription*, Guid*, void**, int>)(lpVtbl[52]))((ID3D12Device6*)Unsafe.AsPointer(ref this), pDesc, riid, ppSession);
#else
	...
	{
#if NET6_0_OR_GREATER
		return ((delegate* unmanaged<ID3D12Device6*, HeapProperties*, HeapFlags, ResourceDescription*, ResourceStates, ClearValue*, ID3D12ProtectedResourceSession*, Guid*, void**, int>)(lpVtbl[53]))((ID3D12Device6*)Unsafe.AsPointer(ref this), pHeapProperties, HeapFlags, pDesc, InitialResourceState, pOptimizedClearValue, pProtectedSession, riidResource, ppvResource);
#else
	...
	{
#if NET6_0_OR_GREATER
		return ((delegate* unmanaged<ID3D12Device6*, HeapDescription*, ID3D12ProtectedResourceSession*, Guid*, void**, int>)(lpVtbl[54]))((ID3D12Device6*)Unsafe.AsPointer(ref this), pDesc, pProtectedSession, riid, ppvHeap);
#else
	...
	{
#if NET6_0_OR_GREATER
		return ((delegate* unmanaged<ID3D12Device6*, ResourceDescription*, ResourceStates, ClearValue*, ID3D12ProtectedResourceSession*, Guid*, void**, int>)(lpVtbl[55]))((ID3D12Device6*)Unsafe.AsPointer(ref this), pDesc, InitialState, pOptimizedClearValue, pProtectedSession, riid, ppvResource);
#else
	...
	public ResourceAllocationInfo GetResourceAllocationInfo1(uint visibleMask, uint numResourceDescs, ResourceDescription* pResourceDescs, ResourceAllocationInfo1* pResourceAllocationInfo1)
	{
		ResourceAllocationInfo result;
#if NET6_0_OR_GREATER
		return *((delegate* unmanaged<ID3D12Device6*, ResourceAllocationInfo*, uint, uint, ResourceDescription*, ResourceAllocationInfo1*, ResourceAllocationInfo*>)(lpVtbl[56]))((ID3D12Device6*)Unsafe.AsPointer(ref this), &result, visibleMask, numResourceDescs, pResourceDescs, pResourceAllocationInfo1);
#else
	...
	{
#if NET6_0_OR_GREATER
		return ((delegate* unmanaged<ID3D12Device6*, uint*, MetaCommandDescription*, int>)(lpVtbl[59]))((ID3D12Device6*)Unsafe.AsPointer(ref this), pNumMetaCommands, pDescs);
#else
	...
	{
#if NET6_0_OR_GREATER
		return ((delegate* unmanaged<ID3D12Device6*, Guid*, MetaCommandParameterStage, uint*, uint*, MetaCommandParameterDescription*, int>)(lpVtbl[60]))((ID3D12Device6*)Unsafe.AsPointer(ref this), CommandId, Stage, pTotalStructureSizeInBytes, pParameterCount, pParameterDescs);
#else
	...
	{
#if NET6_0_OR_GREATER
		return ((delegate* unmanaged<ID3D12Device6*, StateObjectDescription*, Guid*, void**, int>)(lpVtbl[62]))((ID3D12Device6*)Unsafe.AsPointer(ref this), pDesc, riid, ppStateObject);
#else
	...
	{
#if NET6_0_OR_GREATER
		((delegate* unmanaged<ID3D12Device6*, BuildRaytracingAccelerationStructureInputs*, RaytracingAccelerationStructurePrebuildInfo*, void>)(lpVtbl[63]))((ID3D12Device6*)Unsafe.AsPointer(ref this), pDesc, pInfo);
#else
	...
	{
#if NET6_0_OR_GREATER
		return ((delegate* unmanaged<ID3D12Device6*, SerializedDataType, SerializedDataDriverMatchingIdentifier*, DriverMatchingIdentifierStatus>)(lpVtbl[64]))((ID3D12Device6*)Unsafe.AsPointer(ref this), SerializedDataType, pIdentifierToCheck);
#else
	...
	{
#if NET6_0_OR_GREATER
		return ((delegate* unmanaged<ID3D12Device6*, BackgroundProcessingMode, MeasurementsAction, Handle, Bool32*, int>)(lpVtbl[65]))((ID3D12Device6*)Unsafe.AsPointer(ref this), Mode, MeasurementsAction, hEventToSignalUponCompletion, pbFurtherMeasurementsDesired);
#else
