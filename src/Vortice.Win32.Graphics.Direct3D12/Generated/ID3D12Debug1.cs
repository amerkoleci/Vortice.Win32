...
public unsafe partial struct ID3D12Debug1 : ID3D12Debug1.Interface, INativeGuid
{
	...
	{
#if NET6_0_OR_GREATER
		((delegate* unmanaged<ID3D12Debug1*, Bool32, void>)(lpVtbl[4]))((ID3D12Debug1*)Unsafe.AsPointer(ref this), Enable);
#else
	...
	{
#if NET6_0_OR_GREATER
		((delegate* unmanaged<ID3D12Debug1*, Bool32, void>)(lpVtbl[5]))((ID3D12Debug1*)Unsafe.AsPointer(ref this), Enable);
#else
