...
public unsafe partial struct ID3D12Device5 : ID3D12Device5.Interface, INativeGuid
{
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device5*, char*, int>)(lpVtbl[6]))((ID3D12Device5*)Unsafe.AsPointer(ref this), Name);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device5*, ID3D12DeviceChild*, Security.SECURITY_ATTRIBUTES*, uint, char*, Handle*, int>)(lpVtbl[31]))((ID3D12Device5*)Unsafe.AsPointer(ref this), pObject, pAttributes, Access, Name, pHandle);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device5*, char*, uint, Handle*, int>)(lpVtbl[33]))((ID3D12Device5*)Unsafe.AsPointer(ref this), Name, Access, pNTHandle);
	}
