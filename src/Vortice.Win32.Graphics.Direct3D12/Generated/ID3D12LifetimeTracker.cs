...
public unsafe partial struct ID3D12LifetimeTracker : INativeGuid
{
	...
	{
		return ((delegate* unmanaged[Stdcall]<ID3D12LifetimeTracker*, Guid*, void**, int>)(lpVtbl[0]))((ID3D12LifetimeTracker*)Unsafe.AsPointer(ref this), riid, ppvObject);
	}
	...
	public uint AddRef()
	{
		return ((delegate* unmanaged[Stdcall]<ID3D12LifetimeTracker*, uint>)(lpVtbl[1]))((ID3D12LifetimeTracker*)Unsafe.AsPointer(ref this));
	}
	...
	public uint Release()
	{
		return ((delegate* unmanaged[Stdcall]<ID3D12LifetimeTracker*, uint>)(lpVtbl[2]))((ID3D12LifetimeTracker*)Unsafe.AsPointer(ref this));
	}
