...
public unsafe partial struct ID3D12QueryHeap : ID3D12QueryHeap.Interface, INativeGuid
{
	...
	{
#if NET6_0_OR_GREATER
		return ((delegate* unmanaged<ID3D12QueryHeap*, Guid*, void**, int>)(lpVtbl[0]))((ID3D12QueryHeap*)Unsafe.AsPointer(ref this), riid, ppvObject);
#else
	...
	{
#if NET6_0_OR_GREATER
		return ((delegate* unmanaged<ID3D12QueryHeap*, uint>)(lpVtbl[1]))((ID3D12QueryHeap*)Unsafe.AsPointer(ref this));
#else
	...
	{
#if NET6_0_OR_GREATER
		return ((delegate* unmanaged<ID3D12QueryHeap*, uint>)(lpVtbl[2]))((ID3D12QueryHeap*)Unsafe.AsPointer(ref this));
#else
	...
	{
#if NET6_0_OR_GREATER
		return ((delegate* unmanaged<ID3D12QueryHeap*, Guid*, uint*, void*, int>)(lpVtbl[3]))((ID3D12QueryHeap*)Unsafe.AsPointer(ref this), guid, pDataSize, pData);
#else
	...
	{
#if NET6_0_OR_GREATER
		return ((delegate* unmanaged<ID3D12QueryHeap*, Guid*, uint, void*, int>)(lpVtbl[4]))((ID3D12QueryHeap*)Unsafe.AsPointer(ref this), guid, DataSize, pData);
#else
	...
	{
#if NET6_0_OR_GREATER
		return ((delegate* unmanaged<ID3D12QueryHeap*, Guid*, IUnknown*, int>)(lpVtbl[5]))((ID3D12QueryHeap*)Unsafe.AsPointer(ref this), guid, pData);
#else
	...
	{
#if NET6_0_OR_GREATER
		return ((delegate* unmanaged<ID3D12QueryHeap*, ushort*, int>)(lpVtbl[6]))((ID3D12QueryHeap*)Unsafe.AsPointer(ref this), Name);
#else
	...
	{
#if NET6_0_OR_GREATER
		return ((delegate* unmanaged<ID3D12QueryHeap*, Guid*, void**, int>)(lpVtbl[7]))((ID3D12QueryHeap*)Unsafe.AsPointer(ref this), riid, ppvDevice);
#else
