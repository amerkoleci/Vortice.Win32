...
public unsafe partial struct ID3D12Device12 : ID3D12Device12.Interface, INativeGuid
{
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device12*, Guid*, void**, int>)(lpVtbl[0]))((ID3D12Device12*)Unsafe.AsPointer(ref this), riid, ppvObject);
	}
	...
	public uint AddRef()
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device12*, uint>)(lpVtbl[1]))((ID3D12Device12*)Unsafe.AsPointer(ref this));
	}
	...
	public uint Release()
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device12*, uint>)(lpVtbl[2]))((ID3D12Device12*)Unsafe.AsPointer(ref this));
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device12*, Guid*, uint*, void*, int>)(lpVtbl[3]))((ID3D12Device12*)Unsafe.AsPointer(ref this), guid, pDataSize, pData);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device12*, Guid*, uint, void*, int>)(lpVtbl[4]))((ID3D12Device12*)Unsafe.AsPointer(ref this), guid, DataSize, pData);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device12*, Guid*, IUnknown*, int>)(lpVtbl[5]))((ID3D12Device12*)Unsafe.AsPointer(ref this), guid, pData);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device12*, uint>)(lpVtbl[7]))((ID3D12Device12*)Unsafe.AsPointer(ref this));
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device12*, CommandQueueDescription*, Guid*, void**, int>)(lpVtbl[8]))((ID3D12Device12*)Unsafe.AsPointer(ref this), pDesc, riid, ppCommandQueue);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device12*, CommandListType, Guid*, void**, int>)(lpVtbl[9]))((ID3D12Device12*)Unsafe.AsPointer(ref this), type, riid, ppCommandAllocator);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device12*, GraphicsPipelineStateDescription*, Guid*, void**, int>)(lpVtbl[10]))((ID3D12Device12*)Unsafe.AsPointer(ref this), pDesc, riid, ppPipelineState);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device12*, ComputePipelineStateDescription*, Guid*, void**, int>)(lpVtbl[11]))((ID3D12Device12*)Unsafe.AsPointer(ref this), pDesc, riid, ppPipelineState);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device12*, uint, CommandListType, ID3D12CommandAllocator*, ID3D12PipelineState*, Guid*, void**, int>)(lpVtbl[12]))((ID3D12Device12*)Unsafe.AsPointer(ref this), nodeMask, type, pCommandAllocator, pInitialState, riid, ppCommandList);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device12*, Feature, void*, int, int>)(lpVtbl[13]))((ID3D12Device12*)Unsafe.AsPointer(ref this), Feature, pFeatureSupportData, FeatureSupportDataSize);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device12*, DescriptorHeapDescription*, Guid*, void**, int>)(lpVtbl[14]))((ID3D12Device12*)Unsafe.AsPointer(ref this), pDescriptorHeapDesc, riid, ppvHeap);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device12*, DescriptorHeapType, uint>)(lpVtbl[15]))((ID3D12Device12*)Unsafe.AsPointer(ref this), DescriptorHeapType);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device12*, uint, void*, nuint, Guid*, void**, int>)(lpVtbl[16]))((ID3D12Device12*)Unsafe.AsPointer(ref this), nodeMask, pBlobWithRootSignature, blobLengthInBytes, riid, ppvRootSignature);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID3D12Device12*, ConstantBufferViewDescription*, CpuDescriptorHandle, void>)(lpVtbl[17]))((ID3D12Device12*)Unsafe.AsPointer(ref this), pDesc, DestDescriptor);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID3D12Device12*, ID3D12Resource*, ShaderResourceViewDescription*, CpuDescriptorHandle, void>)(lpVtbl[18]))((ID3D12Device12*)Unsafe.AsPointer(ref this), pResource, pDesc, DestDescriptor);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID3D12Device12*, ID3D12Resource*, ID3D12Resource*, UnorderedAccessViewDescription*, CpuDescriptorHandle, void>)(lpVtbl[19]))((ID3D12Device12*)Unsafe.AsPointer(ref this), pResource, pCounterResource, pDesc, DestDescriptor);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID3D12Device12*, ID3D12Resource*, RenderTargetViewDescription*, CpuDescriptorHandle, void>)(lpVtbl[20]))((ID3D12Device12*)Unsafe.AsPointer(ref this), pResource, pDesc, DestDescriptor);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID3D12Device12*, ID3D12Resource*, DepthStencilViewDescription*, CpuDescriptorHandle, void>)(lpVtbl[21]))((ID3D12Device12*)Unsafe.AsPointer(ref this), pResource, pDesc, DestDescriptor);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID3D12Device12*, SamplerDescription*, CpuDescriptorHandle, void>)(lpVtbl[22]))((ID3D12Device12*)Unsafe.AsPointer(ref this), pDesc, DestDescriptor);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID3D12Device12*, uint, CpuDescriptorHandle*, uint*, uint, CpuDescriptorHandle*, uint*, DescriptorHeapType, void>)(lpVtbl[23]))((ID3D12Device12*)Unsafe.AsPointer(ref this), NumDestDescriptorRanges, pDestDescriptorRangeStarts, pDestDescriptorRangeSizes, NumSrcDescriptorRanges, pSrcDescriptorRangeStarts, pSrcDescriptorRangeSizes, DescriptorHeapsType);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID3D12Device12*, uint, CpuDescriptorHandle, CpuDescriptorHandle, DescriptorHeapType, void>)(lpVtbl[24]))((ID3D12Device12*)Unsafe.AsPointer(ref this), NumDescriptors, DestDescriptorRangeStart, SrcDescriptorRangeStart, DescriptorHeapsType);
	}
	...
	public ResourceAllocationInfo GetResourceAllocationInfo(uint visibleMask, uint numResourceDescs, ResourceDescription* pResourceDescs)
	{
		...
		return *((delegate* unmanaged[MemberFunction]<ID3D12Device12*, ResourceAllocationInfo*, uint, uint, ResourceDescription*, ResourceAllocationInfo*>)(lpVtbl[25]))((ID3D12Device12*)Unsafe.AsPointer(ref this), &result, visibleMask, numResourceDescs, pResourceDescs);
	}
	...
	public HeapProperties GetCustomHeapProperties(uint nodeMask, HeapType heapType)
	{
		...
		return *((delegate* unmanaged[MemberFunction]<ID3D12Device12*, HeapProperties*, uint, HeapType, HeapProperties*>)(lpVtbl[26]))((ID3D12Device12*)Unsafe.AsPointer(ref this), &result, nodeMask, heapType);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device12*, HeapProperties*, HeapFlags, ResourceDescription*, ResourceStates, ClearValue*, Guid*, void**, int>)(lpVtbl[27]))((ID3D12Device12*)Unsafe.AsPointer(ref this), pHeapProperties, HeapFlags, pDesc, InitialResourceState, pOptimizedClearValue, riidResource, ppvResource);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device12*, HeapDescription*, Guid*, void**, int>)(lpVtbl[28]))((ID3D12Device12*)Unsafe.AsPointer(ref this), pDesc, riid, ppvHeap);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device12*, ID3D12Heap*, ulong, ResourceDescription*, ResourceStates, ClearValue*, Guid*, void**, int>)(lpVtbl[29]))((ID3D12Device12*)Unsafe.AsPointer(ref this), pHeap, HeapOffset, pDesc, InitialState, pOptimizedClearValue, riid, ppvResource);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device12*, ResourceDescription*, ResourceStates, ClearValue*, Guid*, void**, int>)(lpVtbl[30]))((ID3D12Device12*)Unsafe.AsPointer(ref this), pDesc, InitialState, pOptimizedClearValue, riid, ppvResource);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device12*, Handle, Guid*, void**, int>)(lpVtbl[32]))((ID3D12Device12*)Unsafe.AsPointer(ref this), NTHandle, riid, ppvObj);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device12*, uint, ID3D12Pageable**, int>)(lpVtbl[34]))((ID3D12Device12*)Unsafe.AsPointer(ref this), NumObjects, ppObjects);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device12*, uint, ID3D12Pageable**, int>)(lpVtbl[35]))((ID3D12Device12*)Unsafe.AsPointer(ref this), NumObjects, ppObjects);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device12*, ulong, FenceFlags, Guid*, void**, int>)(lpVtbl[36]))((ID3D12Device12*)Unsafe.AsPointer(ref this), InitialValue, Flags, riid, ppFence);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device12*, int>)(lpVtbl[37]))((ID3D12Device12*)Unsafe.AsPointer(ref this));
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID3D12Device12*, ResourceDescription*, uint, uint, ulong, PlacedSubresourceFootprint*, uint*, ulong*, ulong*, void>)(lpVtbl[38]))((ID3D12Device12*)Unsafe.AsPointer(ref this), pResourceDesc, FirstSubresource, NumSubresources, BaseOffset, pLayouts, pNumRows, pRowSizeInBytes, pTotalBytes);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device12*, QueryHeapDescription*, Guid*, void**, int>)(lpVtbl[39]))((ID3D12Device12*)Unsafe.AsPointer(ref this), pDesc, riid, ppvHeap);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device12*, Bool32, int>)(lpVtbl[40]))((ID3D12Device12*)Unsafe.AsPointer(ref this), Enable);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device12*, CommandSignatureDescription*, ID3D12RootSignature*, Guid*, void**, int>)(lpVtbl[41]))((ID3D12Device12*)Unsafe.AsPointer(ref this), pDesc, pRootSignature, riid, ppvCommandSignature);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID3D12Device12*, ID3D12Resource*, uint*, PackedMipInfo*, TileShape*, uint*, uint, SubresourceTiling*, void>)(lpVtbl[42]))((ID3D12Device12*)Unsafe.AsPointer(ref this), pTiledResource, pNumTilesForEntireResource, pPackedMipDesc, pStandardTileShapeForNonPackedMips, pNumSubresourceTilings, FirstSubresourceTilingToGet, pSubresourceTilingsForNonPackedMips);
	}
	...
	{
		Luid result;
		return *((delegate* unmanaged[MemberFunction]<ID3D12Device12*, Luid*, Luid*>)(lpVtbl[43]))((ID3D12Device12*)Unsafe.AsPointer(ref this), &result);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device12*, void*, nuint, Guid*, void**, int>)(lpVtbl[44]))((ID3D12Device12*)Unsafe.AsPointer(ref this), pLibraryBlob, BlobLength, riid, ppPipelineLibrary);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device12*, ID3D12Fence**, ulong*, uint, MultipleFenceWaitFlags, Handle, int>)(lpVtbl[45]))((ID3D12Device12*)Unsafe.AsPointer(ref this), ppFences, pFenceValues, NumFences, Flags, hEvent);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device12*, uint, ID3D12Pageable**, ResidencyPriority*, int>)(lpVtbl[46]))((ID3D12Device12*)Unsafe.AsPointer(ref this), NumObjects, ppObjects, pPriorities);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device12*, PipelineStateStreamDescription*, Guid*, void**, int>)(lpVtbl[47]))((ID3D12Device12*)Unsafe.AsPointer(ref this), pDesc, riid, ppPipelineState);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device12*, void*, Guid*, void**, int>)(lpVtbl[48]))((ID3D12Device12*)Unsafe.AsPointer(ref this), pAddress, riid, ppvHeap);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device12*, Handle, Guid*, void**, int>)(lpVtbl[49]))((ID3D12Device12*)Unsafe.AsPointer(ref this), hFileMapping, riid, ppvHeap);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device12*, ResidencyFlags, uint, ID3D12Pageable**, ID3D12Fence*, ulong, int>)(lpVtbl[50]))((ID3D12Device12*)Unsafe.AsPointer(ref this), Flags, NumObjects, ppObjects, pFenceToSignal, FenceValueToSignal);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device12*, uint, CommandListType, CommandListFlags, Guid*, void**, int>)(lpVtbl[51]))((ID3D12Device12*)Unsafe.AsPointer(ref this), nodeMask, type, flags, riid, ppCommandList);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device12*, ProtectedResourceSessionDescription*, Guid*, void**, int>)(lpVtbl[52]))((ID3D12Device12*)Unsafe.AsPointer(ref this), pDesc, riid, ppSession);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device12*, HeapProperties*, HeapFlags, ResourceDescription*, ResourceStates, ClearValue*, ID3D12ProtectedResourceSession*, Guid*, void**, int>)(lpVtbl[53]))((ID3D12Device12*)Unsafe.AsPointer(ref this), pHeapProperties, HeapFlags, pDesc, InitialResourceState, pOptimizedClearValue, pProtectedSession, riidResource, ppvResource);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device12*, HeapDescription*, ID3D12ProtectedResourceSession*, Guid*, void**, int>)(lpVtbl[54]))((ID3D12Device12*)Unsafe.AsPointer(ref this), pDesc, pProtectedSession, riid, ppvHeap);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device12*, ResourceDescription*, ResourceStates, ClearValue*, ID3D12ProtectedResourceSession*, Guid*, void**, int>)(lpVtbl[55]))((ID3D12Device12*)Unsafe.AsPointer(ref this), pDesc, InitialState, pOptimizedClearValue, pProtectedSession, riid, ppvResource);
	}
	...
	{
		ResourceAllocationInfo result;
		return *((delegate* unmanaged[MemberFunction]<ID3D12Device12*, ResourceAllocationInfo*, uint, uint, ResourceDescription*, ResourceAllocationInfo1*, ResourceAllocationInfo*>)(lpVtbl[56]))((ID3D12Device12*)Unsafe.AsPointer(ref this), &result, visibleMask, numResourceDescs, pResourceDescs, pResourceAllocationInfo1);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device12*, ID3D12LifetimeOwner*, Guid*, void**, int>)(lpVtbl[57]))((ID3D12Device12*)Unsafe.AsPointer(ref this), pOwner, riid, ppvTracker);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID3D12Device12*, void>)(lpVtbl[58]))((ID3D12Device12*)Unsafe.AsPointer(ref this));
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device12*, uint*, MetaCommandDescription*, int>)(lpVtbl[59]))((ID3D12Device12*)Unsafe.AsPointer(ref this), pNumMetaCommands, pDescs);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device12*, Guid*, MetaCommandParameterStage, uint*, uint*, MetaCommandParameterDescription*, int>)(lpVtbl[60]))((ID3D12Device12*)Unsafe.AsPointer(ref this), CommandId, Stage, pTotalStructureSizeInBytes, pParameterCount, pParameterDescs);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device12*, Guid*, uint, void*, nuint, Guid*, void**, int>)(lpVtbl[61]))((ID3D12Device12*)Unsafe.AsPointer(ref this), CommandId, NodeMask, pCreationParametersData, CreationParametersDataSizeInBytes, riid, ppMetaCommand);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device12*, StateObjectDescription*, Guid*, void**, int>)(lpVtbl[62]))((ID3D12Device12*)Unsafe.AsPointer(ref this), pDesc, riid, ppStateObject);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID3D12Device12*, BuildRaytracingAccelerationStructureInputs*, RaytracingAccelerationStructurePrebuildInfo*, void>)(lpVtbl[63]))((ID3D12Device12*)Unsafe.AsPointer(ref this), pDesc, pInfo);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device12*, SerializedDataType, SerializedDataDriverMatchingIdentifier*, DriverMatchingIdentifierStatus>)(lpVtbl[64]))((ID3D12Device12*)Unsafe.AsPointer(ref this), SerializedDataType, pIdentifierToCheck);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device12*, BackgroundProcessingMode, MeasurementsAction, Handle, Bool32*, int>)(lpVtbl[65]))((ID3D12Device12*)Unsafe.AsPointer(ref this), Mode, MeasurementsAction, hEventToSignalUponCompletion, pbFurtherMeasurementsDesired);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device12*, StateObjectDescription*, ID3D12StateObject*, Guid*, void**, int>)(lpVtbl[66]))((ID3D12Device12*)Unsafe.AsPointer(ref this), pAddition, pStateObjectToGrowFrom, riid, ppNewStateObject);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device12*, ProtectedResourceSessionDescription1*, Guid*, void**, int>)(lpVtbl[67]))((ID3D12Device12*)Unsafe.AsPointer(ref this), pDesc, riid, ppSession);
	}
	...
	{
		ResourceAllocationInfo result;
		return *((delegate* unmanaged[MemberFunction]<ID3D12Device12*, ResourceAllocationInfo*, uint, uint, ResourceDescription1*, ResourceAllocationInfo1*, ResourceAllocationInfo*>)(lpVtbl[68]))((ID3D12Device12*)Unsafe.AsPointer(ref this), &result, visibleMask, numResourceDescs, pResourceDescs, pResourceAllocationInfo1);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device12*, ID3D12Heap*, ulong, ResourceDescription1*, ResourceStates, ClearValue*, Guid*, void**, int>)(lpVtbl[70]))((ID3D12Device12*)Unsafe.AsPointer(ref this), pHeap, HeapOffset, pDesc, InitialState, pOptimizedClearValue, riid, ppvResource);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID3D12Device12*, ID3D12Resource*, ID3D12Resource*, CpuDescriptorHandle, void>)(lpVtbl[71]))((ID3D12Device12*)Unsafe.AsPointer(ref this), pTargetedResource, pFeedbackResource, DestDescriptor);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID3D12Device12*, ResourceDescription1*, uint, uint, ulong, PlacedSubresourceFootprint*, uint*, ulong*, ulong*, void>)(lpVtbl[72]))((ID3D12Device12*)Unsafe.AsPointer(ref this), pResourceDesc, FirstSubresource, NumSubresources, BaseOffset, pLayouts, pNumRows, pRowSizeInBytes, pTotalBytes);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device12*, ShaderCacheSessionDescription*, Guid*, void**, int>)(lpVtbl[73]))((ID3D12Device12*)Unsafe.AsPointer(ref this), pDesc, riid, ppvSession);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device12*, ShaderCacheKindFlags, ShaderCacheControlFlags, int>)(lpVtbl[74]))((ID3D12Device12*)Unsafe.AsPointer(ref this), Kinds, Control);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device12*, CommandQueueDescription*, Guid*, Guid*, void**, int>)(lpVtbl[75]))((ID3D12Device12*)Unsafe.AsPointer(ref this), pDesc, CreatorID, riid, ppCommandQueue);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID3D12Device12*, SamplerDescription2*, CpuDescriptorHandle, void>)(lpVtbl[79]))((ID3D12Device12*)Unsafe.AsPointer(ref this), pDesc, DestDescriptor);
	}
