...
public unsafe partial struct ID3D12Device1 : ID3D12Device1.Interface, INativeGuid
{
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device1*, Guid*, void**, int>)(lpVtbl[0]))((ID3D12Device1*)Unsafe.AsPointer(ref this), riid, ppvObject);
	}
	...
	public uint AddRef()
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device1*, uint>)(lpVtbl[1]))((ID3D12Device1*)Unsafe.AsPointer(ref this));
	}
	...
	public uint Release()
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device1*, uint>)(lpVtbl[2]))((ID3D12Device1*)Unsafe.AsPointer(ref this));
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device1*, Guid*, uint*, void*, int>)(lpVtbl[3]))((ID3D12Device1*)Unsafe.AsPointer(ref this), guid, pDataSize, pData);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device1*, Guid*, uint, void*, int>)(lpVtbl[4]))((ID3D12Device1*)Unsafe.AsPointer(ref this), guid, DataSize, pData);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device1*, Guid*, IUnknown*, int>)(lpVtbl[5]))((ID3D12Device1*)Unsafe.AsPointer(ref this), guid, pData);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device1*, uint>)(lpVtbl[7]))((ID3D12Device1*)Unsafe.AsPointer(ref this));
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device1*, CommandListType, Guid*, void**, int>)(lpVtbl[9]))((ID3D12Device1*)Unsafe.AsPointer(ref this), type, riid, ppCommandAllocator);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device1*, uint, CommandListType, ID3D12CommandAllocator*, ID3D12PipelineState*, Guid*, void**, int>)(lpVtbl[12]))((ID3D12Device1*)Unsafe.AsPointer(ref this), nodeMask, type, pCommandAllocator, pInitialState, riid, ppCommandList);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device1*, Feature, void*, int, int>)(lpVtbl[13]))((ID3D12Device1*)Unsafe.AsPointer(ref this), Feature, pFeatureSupportData, FeatureSupportDataSize);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device1*, DescriptorHeapType, uint>)(lpVtbl[15]))((ID3D12Device1*)Unsafe.AsPointer(ref this), DescriptorHeapType);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device1*, uint, void*, nuint, Guid*, void**, int>)(lpVtbl[16]))((ID3D12Device1*)Unsafe.AsPointer(ref this), nodeMask, pBlobWithRootSignature, blobLengthInBytes, riid, ppvRootSignature);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID3D12Device1*, uint, CpuDescriptorHandle*, uint*, uint, CpuDescriptorHandle*, uint*, DescriptorHeapType, void>)(lpVtbl[23]))((ID3D12Device1*)Unsafe.AsPointer(ref this), NumDestDescriptorRanges, pDestDescriptorRangeStarts, pDestDescriptorRangeSizes, NumSrcDescriptorRanges, pSrcDescriptorRangeStarts, pSrcDescriptorRangeSizes, DescriptorHeapsType);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID3D12Device1*, uint, CpuDescriptorHandle, CpuDescriptorHandle, DescriptorHeapType, void>)(lpVtbl[24]))((ID3D12Device1*)Unsafe.AsPointer(ref this), NumDescriptors, DestDescriptorRangeStart, SrcDescriptorRangeStart, DescriptorHeapsType);
	}
	...
	public HeapProperties GetCustomHeapProperties(uint nodeMask, HeapType heapType)
	{
		...
		return *((delegate* unmanaged[MemberFunction]<ID3D12Device1*, HeapProperties*, uint, HeapType, HeapProperties*>)(lpVtbl[26]))((ID3D12Device1*)Unsafe.AsPointer(ref this), &result, nodeMask, heapType);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device1*, HeapProperties*, HeapFlags, ResourceDescription*, ResourceStates, ClearValue*, Guid*, void**, int>)(lpVtbl[27]))((ID3D12Device1*)Unsafe.AsPointer(ref this), pHeapProperties, HeapFlags, pDesc, InitialResourceState, pOptimizedClearValue, riidResource, ppvResource);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device1*, ID3D12Heap*, ulong, ResourceDescription*, ResourceStates, ClearValue*, Guid*, void**, int>)(lpVtbl[29]))((ID3D12Device1*)Unsafe.AsPointer(ref this), pHeap, HeapOffset, pDesc, InitialState, pOptimizedClearValue, riid, ppvResource);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device1*, ResourceDescription*, ResourceStates, ClearValue*, Guid*, void**, int>)(lpVtbl[30]))((ID3D12Device1*)Unsafe.AsPointer(ref this), pDesc, InitialState, pOptimizedClearValue, riid, ppvResource);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device1*, Handle, Guid*, void**, int>)(lpVtbl[32]))((ID3D12Device1*)Unsafe.AsPointer(ref this), NTHandle, riid, ppvObj);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device1*, uint, ID3D12Pageable**, int>)(lpVtbl[34]))((ID3D12Device1*)Unsafe.AsPointer(ref this), NumObjects, ppObjects);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device1*, uint, ID3D12Pageable**, int>)(lpVtbl[35]))((ID3D12Device1*)Unsafe.AsPointer(ref this), NumObjects, ppObjects);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device1*, ulong, FenceFlags, Guid*, void**, int>)(lpVtbl[36]))((ID3D12Device1*)Unsafe.AsPointer(ref this), InitialValue, Flags, riid, ppFence);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device1*, int>)(lpVtbl[37]))((ID3D12Device1*)Unsafe.AsPointer(ref this));
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device1*, Bool32, int>)(lpVtbl[40]))((ID3D12Device1*)Unsafe.AsPointer(ref this), Enable);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device1*, void*, nuint, Guid*, void**, int>)(lpVtbl[44]))((ID3D12Device1*)Unsafe.AsPointer(ref this), pLibraryBlob, BlobLength, riid, ppPipelineLibrary);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device1*, ID3D12Fence**, ulong*, uint, MultipleFenceWaitFlags, Handle, int>)(lpVtbl[45]))((ID3D12Device1*)Unsafe.AsPointer(ref this), ppFences, pFenceValues, NumFences, Flags, hEvent);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device1*, uint, ID3D12Pageable**, ResidencyPriority*, int>)(lpVtbl[46]))((ID3D12Device1*)Unsafe.AsPointer(ref this), NumObjects, ppObjects, pPriorities);
	}
