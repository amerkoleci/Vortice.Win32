...
public unsafe partial struct ID3D12GraphicsCommandList5 : ID3D12GraphicsCommandList5.Interface, INativeGuid
{
	...
	{
		((delegate* unmanaged[Stdcall]<ID3D12GraphicsCommandList5*, uint, RawRect*, void>)(lpVtbl[22]))((ID3D12GraphicsCommandList5*)Unsafe.AsPointer(ref this), NumRects, pRects);
	}
