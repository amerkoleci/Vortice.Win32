...
public unsafe partial struct ID3D12Device14 : ID3D12Device14.Interface, INativeGuid
{
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device14*, char*, int>)(lpVtbl[6]))((ID3D12Device14*)Unsafe.AsPointer(ref this), Name);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device14*, ID3D12DeviceChild*, Security.SECURITY_ATTRIBUTES*, uint, char*, Handle*, int>)(lpVtbl[31]))((ID3D12Device14*)Unsafe.AsPointer(ref this), pObject, pAttributes, Access, Name, pHandle);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device14*, char*, uint, Handle*, int>)(lpVtbl[33]))((ID3D12Device14*)Unsafe.AsPointer(ref this), Name, Access, pNTHandle);
	}
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	[VtblIndex(82)]
	public HResult CreateRootSignatureFromSubobjectInLibrary(uint nodeMask, void* pLibraryBlob, nuint blobLengthInBytes, char* subobjectName, Guid* riid, void** ppvRootSignature)
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device14*, uint, void*, nuint, char*, Guid*, void**, int>)(lpVtbl[82]))((ID3D12Device14*)Unsafe.AsPointer(ref this), nodeMask, pLibraryBlob, blobLengthInBytes, subobjectName, riid, ppvRootSignature);
	}

	public interface Interface : ID3D12Device13.Interface
	{
		[VtblIndex(82)]
		HResult CreateRootSignatureFromSubobjectInLibrary(uint nodeMask, void* pLibraryBlob, nuint blobLengthInBytes, char* subobjectName, Guid* riid, void** ppvRootSignature);
	}
}
