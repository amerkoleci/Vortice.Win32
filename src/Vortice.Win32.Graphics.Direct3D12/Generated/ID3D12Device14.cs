...
[NativeTypeName("struct ID3D12Device14 : ID3D12Device13")]
[NativeInheritance("ID3D12Device13")]
public unsafe partial struct ID3D12Device14 : ID3D12Device14.Interface, INativeGuid
{
	public static ref readonly Guid IID_ID3D12Device14
	{
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device14*, Guid*, void**, int>)(lpVtbl[0]))((ID3D12Device14*)Unsafe.AsPointer(ref this), riid, ppvObject);
	}
	...
	public uint AddRef()
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device14*, uint>)(lpVtbl[1]))((ID3D12Device14*)Unsafe.AsPointer(ref this));
	}
	...
	public uint Release()
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device14*, uint>)(lpVtbl[2]))((ID3D12Device14*)Unsafe.AsPointer(ref this));
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device14*, Guid*, uint*, void*, int>)(lpVtbl[3]))((ID3D12Device14*)Unsafe.AsPointer(ref this), guid, pDataSize, pData);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device14*, Guid*, uint, void*, int>)(lpVtbl[4]))((ID3D12Device14*)Unsafe.AsPointer(ref this), guid, DataSize, pData);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device14*, Guid*, IUnknown*, int>)(lpVtbl[5]))((ID3D12Device14*)Unsafe.AsPointer(ref this), guid, pData);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device14*, ushort*, int>)(lpVtbl[6]))((ID3D12Device14*)Unsafe.AsPointer(ref this), Name);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device14*, uint>)(lpVtbl[7]))((ID3D12Device14*)Unsafe.AsPointer(ref this));
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device14*, CommandListType, Guid*, void**, int>)(lpVtbl[9]))((ID3D12Device14*)Unsafe.AsPointer(ref this), type, riid, ppCommandAllocator);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device14*, uint, CommandListType, ID3D12CommandAllocator*, ID3D12PipelineState*, Guid*, void**, int>)(lpVtbl[12]))((ID3D12Device14*)Unsafe.AsPointer(ref this), nodeMask, type, pCommandAllocator, pInitialState, riid, ppCommandList);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device14*, Feature, void*, int, int>)(lpVtbl[13]))((ID3D12Device14*)Unsafe.AsPointer(ref this), Feature, pFeatureSupportData, FeatureSupportDataSize);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device14*, DescriptorHeapType, uint>)(lpVtbl[15]))((ID3D12Device14*)Unsafe.AsPointer(ref this), DescriptorHeapType);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device14*, uint, void*, nuint, Guid*, void**, int>)(lpVtbl[16]))((ID3D12Device14*)Unsafe.AsPointer(ref this), nodeMask, pBlobWithRootSignature, blobLengthInBytes, riid, ppvRootSignature);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID3D12Device14*, uint, CpuDescriptorHandle*, uint*, uint, CpuDescriptorHandle*, uint*, DescriptorHeapType, void>)(lpVtbl[23]))((ID3D12Device14*)Unsafe.AsPointer(ref this), NumDestDescriptorRanges, pDestDescriptorRangeStarts, pDestDescriptorRangeSizes, NumSrcDescriptorRanges, pSrcDescriptorRangeStarts, pSrcDescriptorRangeSizes, DescriptorHeapsType);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID3D12Device14*, uint, CpuDescriptorHandle, CpuDescriptorHandle, DescriptorHeapType, void>)(lpVtbl[24]))((ID3D12Device14*)Unsafe.AsPointer(ref this), NumDescriptors, DestDescriptorRangeStart, SrcDescriptorRangeStart, DescriptorHeapsType);
	}
	...
	public HeapProperties GetCustomHeapProperties(uint nodeMask, HeapType heapType)
	{
		...
		return *((delegate* unmanaged[MemberFunction]<ID3D12Device14*, HeapProperties*, uint, HeapType, HeapProperties*>)(lpVtbl[26]))((ID3D12Device14*)Unsafe.AsPointer(ref this), &result, nodeMask, heapType);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device14*, HeapProperties*, HeapFlags, ResourceDescription*, ResourceStates, ClearValue*, Guid*, void**, int>)(lpVtbl[27]))((ID3D12Device14*)Unsafe.AsPointer(ref this), pHeapProperties, HeapFlags, pDesc, InitialResourceState, pOptimizedClearValue, riidResource, ppvResource);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device14*, ID3D12Heap*, ulong, ResourceDescription*, ResourceStates, ClearValue*, Guid*, void**, int>)(lpVtbl[29]))((ID3D12Device14*)Unsafe.AsPointer(ref this), pHeap, HeapOffset, pDesc, InitialState, pOptimizedClearValue, riid, ppvResource);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device14*, ResourceDescription*, ResourceStates, ClearValue*, Guid*, void**, int>)(lpVtbl[30]))((ID3D12Device14*)Unsafe.AsPointer(ref this), pDesc, InitialState, pOptimizedClearValue, riid, ppvResource);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device14*, ID3D12DeviceChild*, Security.SECURITY_ATTRIBUTES*, uint, ushort*, Handle*, int>)(lpVtbl[31]))((ID3D12Device14*)Unsafe.AsPointer(ref this), pObject, pAttributes, Access, Name, pHandle);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device14*, Handle, Guid*, void**, int>)(lpVtbl[32]))((ID3D12Device14*)Unsafe.AsPointer(ref this), NTHandle, riid, ppvObj);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device14*, ushort*, uint, Handle*, int>)(lpVtbl[33]))((ID3D12Device14*)Unsafe.AsPointer(ref this), Name, Access, pNTHandle);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device14*, uint, ID3D12Pageable**, int>)(lpVtbl[34]))((ID3D12Device14*)Unsafe.AsPointer(ref this), NumObjects, ppObjects);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device14*, uint, ID3D12Pageable**, int>)(lpVtbl[35]))((ID3D12Device14*)Unsafe.AsPointer(ref this), NumObjects, ppObjects);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device14*, ulong, FenceFlags, Guid*, void**, int>)(lpVtbl[36]))((ID3D12Device14*)Unsafe.AsPointer(ref this), InitialValue, Flags, riid, ppFence);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device14*, int>)(lpVtbl[37]))((ID3D12Device14*)Unsafe.AsPointer(ref this));
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device14*, Bool32, int>)(lpVtbl[40]))((ID3D12Device14*)Unsafe.AsPointer(ref this), Enable);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device14*, void*, nuint, Guid*, void**, int>)(lpVtbl[44]))((ID3D12Device14*)Unsafe.AsPointer(ref this), pLibraryBlob, BlobLength, riid, ppPipelineLibrary);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device14*, ID3D12Fence**, ulong*, uint, MultipleFenceWaitFlags, Handle, int>)(lpVtbl[45]))((ID3D12Device14*)Unsafe.AsPointer(ref this), ppFences, pFenceValues, NumFences, Flags, hEvent);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device14*, uint, ID3D12Pageable**, ResidencyPriority*, int>)(lpVtbl[46]))((ID3D12Device14*)Unsafe.AsPointer(ref this), NumObjects, ppObjects, pPriorities);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device14*, void*, Guid*, void**, int>)(lpVtbl[48]))((ID3D12Device14*)Unsafe.AsPointer(ref this), pAddress, riid, ppvHeap);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device14*, Handle, Guid*, void**, int>)(lpVtbl[49]))((ID3D12Device14*)Unsafe.AsPointer(ref this), hFileMapping, riid, ppvHeap);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device14*, ResidencyFlags, uint, ID3D12Pageable**, ID3D12Fence*, ulong, int>)(lpVtbl[50]))((ID3D12Device14*)Unsafe.AsPointer(ref this), Flags, NumObjects, ppObjects, pFenceToSignal, FenceValueToSignal);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device14*, uint, CommandListType, CommandListFlags, Guid*, void**, int>)(lpVtbl[51]))((ID3D12Device14*)Unsafe.AsPointer(ref this), nodeMask, type, flags, riid, ppCommandList);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device14*, HeapProperties*, HeapFlags, ResourceDescription*, ResourceStates, ClearValue*, ID3D12ProtectedResourceSession*, Guid*, void**, int>)(lpVtbl[53]))((ID3D12Device14*)Unsafe.AsPointer(ref this), pHeapProperties, HeapFlags, pDesc, InitialResourceState, pOptimizedClearValue, pProtectedSession, riidResource, ppvResource);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device14*, ResourceDescription*, ResourceStates, ClearValue*, ID3D12ProtectedResourceSession*, Guid*, void**, int>)(lpVtbl[55]))((ID3D12Device14*)Unsafe.AsPointer(ref this), pDesc, InitialState, pOptimizedClearValue, pProtectedSession, riid, ppvResource);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device14*, ID3D12LifetimeOwner*, Guid*, void**, int>)(lpVtbl[57]))((ID3D12Device14*)Unsafe.AsPointer(ref this), pOwner, riid, ppvTracker);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID3D12Device14*, void>)(lpVtbl[58]))((ID3D12Device14*)Unsafe.AsPointer(ref this));
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device14*, Guid*, MetaCommandParameterStage, uint*, uint*, MetaCommandParameterDescription*, int>)(lpVtbl[60]))((ID3D12Device14*)Unsafe.AsPointer(ref this), CommandId, Stage, pTotalStructureSizeInBytes, pParameterCount, pParameterDescs);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device14*, Guid*, uint, void*, nuint, Guid*, void**, int>)(lpVtbl[61]))((ID3D12Device14*)Unsafe.AsPointer(ref this), CommandId, NodeMask, pCreationParametersData, CreationParametersDataSizeInBytes, riid, ppMetaCommand);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device14*, SerializedDataType, SerializedDataDriverMatchingIdentifier*, DriverMatchingIdentifierStatus>)(lpVtbl[64]))((ID3D12Device14*)Unsafe.AsPointer(ref this), SerializedDataType, pIdentifierToCheck);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device14*, BackgroundProcessingMode, MeasurementsAction, Handle, Bool32*, int>)(lpVtbl[65]))((ID3D12Device14*)Unsafe.AsPointer(ref this), Mode, MeasurementsAction, hEventToSignalUponCompletion, pbFurtherMeasurementsDesired);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device14*, HeapProperties*, HeapFlags, ResourceDescription1*, ResourceStates, ClearValue*, ID3D12ProtectedResourceSession*, Guid*, void**, int>)(lpVtbl[69]))((ID3D12Device14*)Unsafe.AsPointer(ref this), pHeapProperties, HeapFlags, pDesc, InitialResourceState, pOptimizedClearValue, pProtectedSession, riidResource, ppvResource);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device14*, ID3D12Heap*, ulong, ResourceDescription1*, ResourceStates, ClearValue*, Guid*, void**, int>)(lpVtbl[70]))((ID3D12Device14*)Unsafe.AsPointer(ref this), pHeap, HeapOffset, pDesc, InitialState, pOptimizedClearValue, riid, ppvResource);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device14*, ShaderCacheKindFlags, ShaderCacheControlFlags, int>)(lpVtbl[74]))((ID3D12Device14*)Unsafe.AsPointer(ref this), Kinds, Control);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device14*, void*, nuint, Guid*, void**, int>)(lpVtbl[81]))((ID3D12Device14*)Unsafe.AsPointer(ref this), pAddress, size, riid, ppvHeap);
	}

	/// <include file='../Direct3D12.xml' path='doc/member[@name="ID3D12Device14::CreateRootSignatureFromSubobjectInLibrary"]/*' />
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	[VtblIndex(82)]
	public HResult CreateRootSignatureFromSubobjectInLibrary(uint nodeMask, void* pLibraryBlob, nuint blobLengthInBytes, ushort* subobjectName, Guid* riid, void** ppvRootSignature)
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device14*, uint, void*, nuint, ushort*, Guid*, void**, int>)(lpVtbl[82]))((ID3D12Device14*)Unsafe.AsPointer(ref this), nodeMask, pLibraryBlob, blobLengthInBytes, subobjectName, riid, ppvRootSignature);
	}

	public interface Interface : ID3D12Device13.Interface
	{
		[VtblIndex(82)]
		HResult CreateRootSignatureFromSubobjectInLibrary(uint nodeMask, void* pLibraryBlob, nuint blobLengthInBytes, ushort* subobjectName, Guid* riid, void** ppvRootSignature);
	}
}
