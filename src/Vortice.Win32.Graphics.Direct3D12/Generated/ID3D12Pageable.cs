...
public unsafe partial struct ID3D12Pageable : ID3D12Pageable.Interface, INativeGuid
{
	...
	{
#if NET6_0_OR_GREATER
		return ((delegate* unmanaged<ID3D12Pageable*, Guid*, void**, int>)(lpVtbl[0]))((ID3D12Pageable*)Unsafe.AsPointer(ref this), riid, ppvObject);
#else
	...
	{
#if NET6_0_OR_GREATER
		return ((delegate* unmanaged<ID3D12Pageable*, uint>)(lpVtbl[1]))((ID3D12Pageable*)Unsafe.AsPointer(ref this));
#else
	...
	{
#if NET6_0_OR_GREATER
		return ((delegate* unmanaged<ID3D12Pageable*, uint>)(lpVtbl[2]))((ID3D12Pageable*)Unsafe.AsPointer(ref this));
#else
	...
	{
#if NET6_0_OR_GREATER
		return ((delegate* unmanaged<ID3D12Pageable*, Guid*, uint*, void*, int>)(lpVtbl[3]))((ID3D12Pageable*)Unsafe.AsPointer(ref this), guid, pDataSize, pData);
#else
	...
	{
#if NET6_0_OR_GREATER
		return ((delegate* unmanaged<ID3D12Pageable*, Guid*, uint, void*, int>)(lpVtbl[4]))((ID3D12Pageable*)Unsafe.AsPointer(ref this), guid, DataSize, pData);
#else
	...
	{
#if NET6_0_OR_GREATER
		return ((delegate* unmanaged<ID3D12Pageable*, Guid*, IUnknown*, int>)(lpVtbl[5]))((ID3D12Pageable*)Unsafe.AsPointer(ref this), guid, pData);
#else
	...
	{
#if NET6_0_OR_GREATER
		return ((delegate* unmanaged<ID3D12Pageable*, ushort*, int>)(lpVtbl[6]))((ID3D12Pageable*)Unsafe.AsPointer(ref this), Name);
#else
