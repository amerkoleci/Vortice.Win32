...
public unsafe partial struct ID3D12MetaCommand : ID3D12MetaCommand.Interface, INativeGuid
{
...
#else
		return ((delegate* unmanaged[Stdcall]<ID3D12MetaCommand*, Guid*, void**, int>)(lpVtbl[0]))((ID3D12MetaCommand*)Unsafe.AsPointer(ref this), riid, ppvObject);
#endif
	}
...
#else
		return ((delegate* unmanaged[Stdcall]<ID3D12MetaCommand*, uint>)(lpVtbl[1]))((ID3D12MetaCommand*)Unsafe.AsPointer(ref this));
#endif
	}
...
#else
		return ((delegate* unmanaged[Stdcall]<ID3D12MetaCommand*, uint>)(lpVtbl[2]))((ID3D12MetaCommand*)Unsafe.AsPointer(ref this));
#endif
	}
	...
	{
#if NET6_0_OR_GREATER
		return ((delegate* unmanaged<ID3D12MetaCommand*, MetaCommandParameterStage, uint, ulong>)(lpVtbl[8]))((ID3D12MetaCommand*)Unsafe.AsPointer(ref this), Stage, ParameterIndex);
#else
