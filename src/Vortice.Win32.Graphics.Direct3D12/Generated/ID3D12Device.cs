...
public unsafe partial struct ID3D12Device : ID3D12Device.Interface, INativeGuid
{
	...
	public uint AddRef()
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device*, uint>)(lpVtbl[1]))((ID3D12Device*)Unsafe.AsPointer(ref this));
	}
	...
	public uint Release()
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device*, uint>)(lpVtbl[2]))((ID3D12Device*)Unsafe.AsPointer(ref this));
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device*, uint>)(lpVtbl[7]))((ID3D12Device*)Unsafe.AsPointer(ref this));
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device*, CommandQueueDescription*, Guid*, void**, int>)(lpVtbl[8]))((ID3D12Device*)Unsafe.AsPointer(ref this), pDesc, riid, ppCommandQueue);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device*, GraphicsPipelineStateDescription*, Guid*, void**, int>)(lpVtbl[10]))((ID3D12Device*)Unsafe.AsPointer(ref this), pDesc, riid, ppPipelineState);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device*, ComputePipelineStateDescription*, Guid*, void**, int>)(lpVtbl[11]))((ID3D12Device*)Unsafe.AsPointer(ref this), pDesc, riid, ppPipelineState);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device*, DescriptorHeapDescription*, Guid*, void**, int>)(lpVtbl[14]))((ID3D12Device*)Unsafe.AsPointer(ref this), pDescriptorHeapDesc, riid, ppvHeap);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID3D12Device*, ConstantBufferViewDescription*, CpuDescriptorHandle, void>)(lpVtbl[17]))((ID3D12Device*)Unsafe.AsPointer(ref this), pDesc, DestDescriptor);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID3D12Device*, ID3D12Resource*, ShaderResourceViewDescription*, CpuDescriptorHandle, void>)(lpVtbl[18]))((ID3D12Device*)Unsafe.AsPointer(ref this), pResource, pDesc, DestDescriptor);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID3D12Device*, ID3D12Resource*, ID3D12Resource*, UnorderedAccessViewDescription*, CpuDescriptorHandle, void>)(lpVtbl[19]))((ID3D12Device*)Unsafe.AsPointer(ref this), pResource, pCounterResource, pDesc, DestDescriptor);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID3D12Device*, ID3D12Resource*, RenderTargetViewDescription*, CpuDescriptorHandle, void>)(lpVtbl[20]))((ID3D12Device*)Unsafe.AsPointer(ref this), pResource, pDesc, DestDescriptor);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID3D12Device*, ID3D12Resource*, DepthStencilViewDescription*, CpuDescriptorHandle, void>)(lpVtbl[21]))((ID3D12Device*)Unsafe.AsPointer(ref this), pResource, pDesc, DestDescriptor);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID3D12Device*, SamplerDescription*, CpuDescriptorHandle, void>)(lpVtbl[22]))((ID3D12Device*)Unsafe.AsPointer(ref this), pDesc, DestDescriptor);
	}
	...
	public ResourceAllocationInfo GetResourceAllocationInfo(uint visibleMask, uint numResourceDescs, ResourceDescription* pResourceDescs)
	{
		...
		return *((delegate* unmanaged[MemberFunction]<ID3D12Device*, ResourceAllocationInfo*, uint, uint, ResourceDescription*, ResourceAllocationInfo*>)(lpVtbl[25]))((ID3D12Device*)Unsafe.AsPointer(ref this), &result, visibleMask, numResourceDescs, pResourceDescs);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device*, HeapDescription*, Guid*, void**, int>)(lpVtbl[28]))((ID3D12Device*)Unsafe.AsPointer(ref this), pDesc, riid, ppvHeap);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID3D12Device*, ResourceDescription*, uint, uint, ulong, PlacedSubresourceFootprint*, uint*, ulong*, ulong*, void>)(lpVtbl[38]))((ID3D12Device*)Unsafe.AsPointer(ref this), pResourceDesc, FirstSubresource, NumSubresources, BaseOffset, pLayouts, pNumRows, pRowSizeInBytes, pTotalBytes);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device*, QueryHeapDescription*, Guid*, void**, int>)(lpVtbl[39]))((ID3D12Device*)Unsafe.AsPointer(ref this), pDesc, riid, ppvHeap);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID3D12Device*, CommandSignatureDescription*, ID3D12RootSignature*, Guid*, void**, int>)(lpVtbl[41]))((ID3D12Device*)Unsafe.AsPointer(ref this), pDesc, pRootSignature, riid, ppvCommandSignature);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID3D12Device*, ID3D12Resource*, uint*, PackedMipInfo*, TileShape*, uint*, uint, SubresourceTiling*, void>)(lpVtbl[42]))((ID3D12Device*)Unsafe.AsPointer(ref this), pTiledResource, pNumTilesForEntireResource, pPackedMipDesc, pStandardTileShapeForNonPackedMips, pNumSubresourceTilings, FirstSubresourceTilingToGet, pSubresourceTilingsForNonPackedMips);
	}
	...
	{
		Luid result;
		return *((delegate* unmanaged[MemberFunction]<ID3D12Device*, Luid*, Luid*>)(lpVtbl[43]))((ID3D12Device*)Unsafe.AsPointer(ref this), &result);
	}
