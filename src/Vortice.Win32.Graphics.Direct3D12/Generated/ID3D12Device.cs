...
public unsafe partial struct ID3D12Device : ID3D12Device.Interface, INativeGuid
{
	...
	{
#if NET6_0_OR_GREATER
		return ((delegate* unmanaged<ID3D12Device*, CommandQueueDescription*, Guid*, void**, int>)(lpVtbl[8]))((ID3D12Device*)Unsafe.AsPointer(ref this), pDesc, riid, ppCommandQueue);
#else
	...
	{
#if NET6_0_OR_GREATER
		return ((delegate* unmanaged<ID3D12Device*, CommandListType, Guid*, void**, int>)(lpVtbl[9]))((ID3D12Device*)Unsafe.AsPointer(ref this), type, riid, ppCommandAllocator);
#else
	...
	{
#if NET6_0_OR_GREATER
		return ((delegate* unmanaged<ID3D12Device*, GraphicsPipelineStateDescription*, Guid*, void**, int>)(lpVtbl[10]))((ID3D12Device*)Unsafe.AsPointer(ref this), pDesc, riid, ppPipelineState);
#else
	...
	{
#if NET6_0_OR_GREATER
		return ((delegate* unmanaged<ID3D12Device*, ComputePipelineStateDescription*, Guid*, void**, int>)(lpVtbl[11]))((ID3D12Device*)Unsafe.AsPointer(ref this), pDesc, riid, ppPipelineState);
#else
	...
	{
#if NET6_0_OR_GREATER
		return ((delegate* unmanaged<ID3D12Device*, uint, CommandListType, ID3D12CommandAllocator*, ID3D12PipelineState*, Guid*, void**, int>)(lpVtbl[12]))((ID3D12Device*)Unsafe.AsPointer(ref this), nodeMask, type, pCommandAllocator, pInitialState, riid, ppCommandList);
#else
	...
	{
#if NET6_0_OR_GREATER
		return ((delegate* unmanaged<ID3D12Device*, Feature, void*, int, int>)(lpVtbl[13]))((ID3D12Device*)Unsafe.AsPointer(ref this), Feature, pFeatureSupportData, FeatureSupportDataSize);
#else
	...
	{
#if NET6_0_OR_GREATER
		return ((delegate* unmanaged<ID3D12Device*, DescriptorHeapDescription*, Guid*, void**, int>)(lpVtbl[14]))((ID3D12Device*)Unsafe.AsPointer(ref this), pDescriptorHeapDesc, riid, ppvHeap);
#else
	...
	{
#if NET6_0_OR_GREATER
		return ((delegate* unmanaged<ID3D12Device*, DescriptorHeapType, uint>)(lpVtbl[15]))((ID3D12Device*)Unsafe.AsPointer(ref this), DescriptorHeapType);
#else
	...
	{
#if NET6_0_OR_GREATER
		((delegate* unmanaged<ID3D12Device*, ConstantBufferViewDescription*, CpuDescriptorHandle, void>)(lpVtbl[17]))((ID3D12Device*)Unsafe.AsPointer(ref this), pDesc, DestDescriptor);
#else
	...
	{
#if NET6_0_OR_GREATER
		((delegate* unmanaged<ID3D12Device*, ID3D12Resource*, ShaderResourceViewDescription*, CpuDescriptorHandle, void>)(lpVtbl[18]))((ID3D12Device*)Unsafe.AsPointer(ref this), pResource, pDesc, DestDescriptor);
#else
	...
	{
#if NET6_0_OR_GREATER
		((delegate* unmanaged<ID3D12Device*, ID3D12Resource*, ID3D12Resource*, UnorderedAccessViewDescription*, CpuDescriptorHandle, void>)(lpVtbl[19]))((ID3D12Device*)Unsafe.AsPointer(ref this), pResource, pCounterResource, pDesc, DestDescriptor);
#else
	...
	{
#if NET6_0_OR_GREATER
		((delegate* unmanaged<ID3D12Device*, ID3D12Resource*, RenderTargetViewDescription*, CpuDescriptorHandle, void>)(lpVtbl[20]))((ID3D12Device*)Unsafe.AsPointer(ref this), pResource, pDesc, DestDescriptor);
#else
	...
	{
#if NET6_0_OR_GREATER
		((delegate* unmanaged<ID3D12Device*, ID3D12Resource*, DepthStencilViewDescription*, CpuDescriptorHandle, void>)(lpVtbl[21]))((ID3D12Device*)Unsafe.AsPointer(ref this), pResource, pDesc, DestDescriptor);
#else
	...
	{
#if NET6_0_OR_GREATER
		((delegate* unmanaged<ID3D12Device*, SamplerDescription*, CpuDescriptorHandle, void>)(lpVtbl[22]))((ID3D12Device*)Unsafe.AsPointer(ref this), pDesc, DestDescriptor);
#else
	...
	{
#if NET6_0_OR_GREATER
		((delegate* unmanaged<ID3D12Device*, uint, CpuDescriptorHandle*, uint*, uint, CpuDescriptorHandle*, uint*, DescriptorHeapType, void>)(lpVtbl[23]))((ID3D12Device*)Unsafe.AsPointer(ref this), NumDestDescriptorRanges, pDestDescriptorRangeStarts, pDestDescriptorRangeSizes, NumSrcDescriptorRanges, pSrcDescriptorRangeStarts, pSrcDescriptorRangeSizes, DescriptorHeapsType);
#else
	...
	{
#if NET6_0_OR_GREATER
		((delegate* unmanaged<ID3D12Device*, uint, CpuDescriptorHandle, CpuDescriptorHandle, DescriptorHeapType, void>)(lpVtbl[24]))((ID3D12Device*)Unsafe.AsPointer(ref this), NumDescriptors, DestDescriptorRangeStart, SrcDescriptorRangeStart, DescriptorHeapsType);
#else
...
#if NET6_0_OR_GREATER
		return *((delegate* unmanaged<ID3D12Device*, ResourceAllocationInfo*, uint, uint, ResourceDescription*, ResourceAllocationInfo*>)(lpVtbl[25]))((ID3D12Device*)Unsafe.AsPointer(ref this), &result, visibleMask, numResourceDescs, pResourceDescs);
#else
...
#if NET6_0_OR_GREATER
		return *((delegate* unmanaged<ID3D12Device*, HeapProperties*, uint, HeapType, HeapProperties*>)(lpVtbl[26]))((ID3D12Device*)Unsafe.AsPointer(ref this), &result, nodeMask, heapType);
#else
	...
	{
#if NET6_0_OR_GREATER
		return ((delegate* unmanaged<ID3D12Device*, HeapProperties*, HeapFlags, ResourceDescription*, ResourceStates, ClearValue*, Guid*, void**, int>)(lpVtbl[27]))((ID3D12Device*)Unsafe.AsPointer(ref this), pHeapProperties, HeapFlags, pDesc, InitialResourceState, pOptimizedClearValue, riidResource, ppvResource);
#else
	...
	{
#if NET6_0_OR_GREATER
		return ((delegate* unmanaged<ID3D12Device*, HeapDescription*, Guid*, void**, int>)(lpVtbl[28]))((ID3D12Device*)Unsafe.AsPointer(ref this), pDesc, riid, ppvHeap);
#else
	...
	{
#if NET6_0_OR_GREATER
		return ((delegate* unmanaged<ID3D12Device*, ID3D12Heap*, ulong, ResourceDescription*, ResourceStates, ClearValue*, Guid*, void**, int>)(lpVtbl[29]))((ID3D12Device*)Unsafe.AsPointer(ref this), pHeap, HeapOffset, pDesc, InitialState, pOptimizedClearValue, riid, ppvResource);
#else
	...
	{
#if NET6_0_OR_GREATER
		return ((delegate* unmanaged<ID3D12Device*, ResourceDescription*, ResourceStates, ClearValue*, Guid*, void**, int>)(lpVtbl[30]))((ID3D12Device*)Unsafe.AsPointer(ref this), pDesc, InitialState, pOptimizedClearValue, riid, ppvResource);
#else
	...
	{
#if NET6_0_OR_GREATER
		return ((delegate* unmanaged<ID3D12Device*, ID3D12DeviceChild*, Security.SECURITY_ATTRIBUTES*, uint, ushort*, Handle*, int>)(lpVtbl[31]))((ID3D12Device*)Unsafe.AsPointer(ref this), pObject, pAttributes, Access, Name, pHandle);
#else
	...
	{
#if NET6_0_OR_GREATER
		return ((delegate* unmanaged<ID3D12Device*, ulong, FenceFlags, Guid*, void**, int>)(lpVtbl[36]))((ID3D12Device*)Unsafe.AsPointer(ref this), InitialValue, Flags, riid, ppFence);
#else
	...
	{
#if NET6_0_OR_GREATER
		((delegate* unmanaged<ID3D12Device*, ResourceDescription*, uint, uint, ulong, PlacedSubresourceFootprint*, uint*, ulong*, ulong*, void>)(lpVtbl[38]))((ID3D12Device*)Unsafe.AsPointer(ref this), pResourceDesc, FirstSubresource, NumSubresources, BaseOffset, pLayouts, pNumRows, pRowSizeInBytes, pTotalBytes);
#else
	...
	{
#if NET6_0_OR_GREATER
		return ((delegate* unmanaged<ID3D12Device*, QueryHeapDescription*, Guid*, void**, int>)(lpVtbl[39]))((ID3D12Device*)Unsafe.AsPointer(ref this), pDesc, riid, ppvHeap);
#else
	...
	{
#if NET6_0_OR_GREATER
		return ((delegate* unmanaged<ID3D12Device*, Bool32, int>)(lpVtbl[40]))((ID3D12Device*)Unsafe.AsPointer(ref this), Enable);
#else
	...
	{
#if NET6_0_OR_GREATER
		return ((delegate* unmanaged<ID3D12Device*, CommandSignatureDescription*, ID3D12RootSignature*, Guid*, void**, int>)(lpVtbl[41]))((ID3D12Device*)Unsafe.AsPointer(ref this), pDesc, pRootSignature, riid, ppvCommandSignature);
#else
	...
	{
#if NET6_0_OR_GREATER
		((delegate* unmanaged<ID3D12Device*, ID3D12Resource*, uint*, PackedMipInfo*, TileShape*, uint*, uint, SubresourceTiling*, void>)(lpVtbl[42]))((ID3D12Device*)Unsafe.AsPointer(ref this), pTiledResource, pNumTilesForEntireResource, pPackedMipDesc, pStandardTileShapeForNonPackedMips, pNumSubresourceTilings, FirstSubresourceTilingToGet, pSubresourceTilingsForNonPackedMips);
#else
