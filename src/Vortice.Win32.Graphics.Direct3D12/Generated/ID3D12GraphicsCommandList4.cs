...
public unsafe partial struct ID3D12GraphicsCommandList4 : ID3D12GraphicsCommandList4.Interface, INativeGuid
{
	...
	{
		((delegate* unmanaged[Stdcall]<ID3D12GraphicsCommandList4*, uint, RawRect*, void>)(lpVtbl[22]))((ID3D12GraphicsCommandList4*)Unsafe.AsPointer(ref this), NumRects, pRects);
	}
