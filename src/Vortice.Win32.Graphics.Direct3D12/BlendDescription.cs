...
public unsafe partial struct BlendDescription
{
    ...
    /// </summary>
    public static BlendDescription AlphaBlend => new(Blend.One, Blend.InverseSrcAlpha);
    ...
    /// </summary>
    public static BlendDescription Additive => new(Blend.SrcAlpha, Blend.One);
    ...
    /// </summary>
    public static BlendDescription NonPremultiplied => new(Blend.SrcAlpha, Blend.InverseSrcAlpha);
