...
public unsafe partial struct ID2D1RenderTarget : ID2D1RenderTarget.Interface, INativeGuid
{
	...
	{
		((delegate* unmanaged[MemberFunction]<ID2D1RenderTarget*, Vortice.Win32.Numerics.RectF*, ID2D1Brush*, float, ID2D1StrokeStyle*, void>)(lpVtbl[16]))((ID2D1RenderTarget*)Unsafe.AsPointer(ref this), rect, brush, strokeWidth, strokeStyle);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID2D1RenderTarget*, Vortice.Win32.Numerics.RectF*, ID2D1Brush*, void>)(lpVtbl[17]))((ID2D1RenderTarget*)Unsafe.AsPointer(ref this), rect, brush);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID2D1RenderTarget*, ID2D1Bitmap*, ID2D1Brush*, OpacityMaskContent, Vortice.Win32.Numerics.RectF*, Vortice.Win32.Numerics.RectF*, void>)(lpVtbl[25]))((ID2D1RenderTarget*)Unsafe.AsPointer(ref this), opacityMask, brush, content, destinationRectangle, sourceRectangle);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID2D1RenderTarget*, ID2D1Bitmap*, Vortice.Win32.Numerics.RectF*, float, BitmapInterpolationMode, Vortice.Win32.Numerics.RectF*, void>)(lpVtbl[26]))((ID2D1RenderTarget*)Unsafe.AsPointer(ref this), bitmap, destinationRectangle, opacity, interpolationMode, sourceRectangle);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID2D1RenderTarget*, Vortice.Win32.Numerics.RectF*, AntialiasMode, void>)(lpVtbl[45]))((ID2D1RenderTarget*)Unsafe.AsPointer(ref this), clipRect, antialiasMode);
	}
	...
	public interface Interface : ID2D1Resource.Interface
	{
		...
		[VtblIndex(16)]
		void DrawRectangle(Vortice.Win32.Numerics.RectF* rect, ID2D1Brush* brush, float strokeWidth, ID2D1StrokeStyle* strokeStyle);

		[VtblIndex(17)]
		void FillRectangle(Vortice.Win32.Numerics.RectF* rect, ID2D1Brush* brush);
		...
		[VtblIndex(25)]
		void FillOpacityMask(ID2D1Bitmap* opacityMask, ID2D1Brush* brush, OpacityMaskContent content, Vortice.Win32.Numerics.RectF* destinationRectangle, Vortice.Win32.Numerics.RectF* sourceRectangle);

		[VtblIndex(26)]
		void DrawBitmap(ID2D1Bitmap* bitmap, Vortice.Win32.Numerics.RectF* destinationRectangle, float opacity, BitmapInterpolationMode interpolationMode, Vortice.Win32.Numerics.RectF* sourceRectangle);

		[VtblIndex(27)]
		void DrawText(char* @string, uint stringLength, Graphics.DirectWrite.IDWriteTextFormat* textFormat, Vortice.Win32.Numerics.RectF* layoutRect, ID2D1Brush* defaultFillBrush, DrawTextOptions options, Graphics.DirectWrite.MeasuringMode measuringMode);
		...
		[VtblIndex(45)]
		void PushAxisAlignedClip(Vortice.Win32.Numerics.RectF* clipRect, AntialiasMode antialiasMode);
