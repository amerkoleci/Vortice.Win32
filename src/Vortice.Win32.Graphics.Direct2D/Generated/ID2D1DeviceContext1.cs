...
public unsafe partial struct ID2D1DeviceContext1 : ID2D1DeviceContext1.Interface, INativeGuid
{
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext1*, Common.GradientStop*, uint, Gamma, ExtendMode, ID2D1GradientStopCollection**, int>)(lpVtbl[9]))((ID2D1DeviceContext1*)Unsafe.AsPointer(ref this), gradientStops, gradientStopsCount, colorInterpolationGamma, extendMode, gradientStopCollection);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext1*, Vortice.Win32.Numerics.RectF*, ID2D1Brush*, float, ID2D1StrokeStyle*, void>)(lpVtbl[16]))((ID2D1DeviceContext1*)Unsafe.AsPointer(ref this), rect, brush, strokeWidth, strokeStyle);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext1*, Vortice.Win32.Numerics.RectF*, ID2D1Brush*, void>)(lpVtbl[17]))((ID2D1DeviceContext1*)Unsafe.AsPointer(ref this), rect, brush);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext1*, ID2D1Bitmap*, ID2D1Brush*, OpacityMaskContent, Vortice.Win32.Numerics.RectF*, Vortice.Win32.Numerics.RectF*, void>)(lpVtbl[25]))((ID2D1DeviceContext1*)Unsafe.AsPointer(ref this), opacityMask, brush, content, destinationRectangle, sourceRectangle);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext1*, ID2D1Bitmap*, Vortice.Win32.Numerics.RectF*, float, BitmapInterpolationMode, Vortice.Win32.Numerics.RectF*, void>)(lpVtbl[26]))((ID2D1DeviceContext1*)Unsafe.AsPointer(ref this), bitmap, destinationRectangle, opacity, interpolationMode, sourceRectangle);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext1*, Vortice.Win32.Numerics.RectF*, AntialiasMode, void>)(lpVtbl[45]))((ID2D1DeviceContext1*)Unsafe.AsPointer(ref this), clipRect, antialiasMode);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext1*, ID2D1Image*, Vortice.Win32.Numerics.RectF**, int>)(lpVtbl[70]))((ID2D1DeviceContext1*)Unsafe.AsPointer(ref this), image, localBounds);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext1*, ID2D1Image*, Vortice.Win32.Numerics.RectF**, int>)(lpVtbl[71]))((ID2D1DeviceContext1*)Unsafe.AsPointer(ref this), image, worldBounds);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext1*, Vector2, Graphics.DirectWrite.GlyphRun*, Graphics.DirectWrite.MeasuringMode, Vortice.Win32.Numerics.RectF**, int>)(lpVtbl[72]))((ID2D1DeviceContext1*)Unsafe.AsPointer(ref this), baselineOrigin, glyphRun, measuringMode, bounds);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext1*, ID2D1Image*, Vector2*, Vortice.Win32.Numerics.RectF*, InterpolationMode, Common.CompositeMode, void>)(lpVtbl[83]))((ID2D1DeviceContext1*)Unsafe.AsPointer(ref this), image, targetOffset, imageRectangle, interpolationMode, compositeMode);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext1*, ID2D1Bitmap*, Vortice.Win32.Numerics.RectF*, float, InterpolationMode, Vortice.Win32.Numerics.RectF*, Matrix4x4*, void>)(lpVtbl[85]))((ID2D1DeviceContext1*)Unsafe.AsPointer(ref this), bitmap, destinationRectangle, opacity, interpolationMode, sourceRectangle, perspectiveTransform);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext1*, ID2D1Effect*, uint, Vortice.Win32.Numerics.RectF*, int>)(lpVtbl[87]))((ID2D1DeviceContext1*)Unsafe.AsPointer(ref this), effect, input, inputRectangle);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext1*, ID2D1Effect*, Vortice.Win32.Numerics.RectF**, uint, int>)(lpVtbl[89]))((ID2D1DeviceContext1*)Unsafe.AsPointer(ref this), effect, rectangles, rectanglesCount);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext1*, ID2D1Effect*, Vortice.Win32.Numerics.RectF*, EffectInputDescription*, Vortice.Win32.Numerics.RectF**, uint, int>)(lpVtbl[90]))((ID2D1DeviceContext1*)Unsafe.AsPointer(ref this), renderEffect, renderImageRectangle, inputDescriptions, requiredInputRects, inputCount);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext1*, ID2D1Bitmap*, ID2D1Brush*, Vortice.Win32.Numerics.RectF*, Vortice.Win32.Numerics.RectF*, void>)(lpVtbl[91]))((ID2D1DeviceContext1*)Unsafe.AsPointer(ref this), opacityMask, brush, destinationRectangle, sourceRectangle);
	}
