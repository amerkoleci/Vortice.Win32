...
public unsafe partial struct ID2D1DeviceContext4 : ID2D1DeviceContext4.Interface, INativeGuid
{
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, Guid*, void**, int>)(lpVtbl[0]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), riid, ppvObject);
	}
	...
	public uint AddRef()
	{
		return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, uint>)(lpVtbl[1]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this));
	}
	...
	public uint Release()
	{
		return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, uint>)(lpVtbl[2]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this));
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, ID2D1Factory**, void>)(lpVtbl[3]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), factory);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, System.Drawing.Size, void*, uint, BitmapProperties*, ID2D1Bitmap**, int>)(lpVtbl[4]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), size, srcData, pitch, bitmapProperties, bitmap);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, Graphics.Imaging.IWICBitmapSource*, BitmapProperties*, ID2D1Bitmap**, int>)(lpVtbl[5]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), wicBitmapSource, bitmapProperties, bitmap);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, Guid*, void*, BitmapProperties*, ID2D1Bitmap**, int>)(lpVtbl[6]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), riid, data, bitmapProperties, bitmap);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, ID2D1Bitmap*, BitmapBrushProperties*, BrushProperties*, ID2D1BitmapBrush**, int>)(lpVtbl[7]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), bitmap, bitmapBrushProperties, brushProperties, bitmapBrush);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, Color4*, BrushProperties*, ID2D1SolidColorBrush**, int>)(lpVtbl[8]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), color, brushProperties, solidColorBrush);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, Common.GradientStop*, uint, Gamma, ExtendMode, ID2D1GradientStopCollection**, int>)(lpVtbl[9]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), gradientStops, gradientStopsCount, colorInterpolationGamma, extendMode, gradientStopCollection);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, LinearGradientBrushProperties*, BrushProperties*, ID2D1GradientStopCollection*, ID2D1LinearGradientBrush**, int>)(lpVtbl[10]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), linearGradientBrushProperties, brushProperties, gradientStopCollection, linearGradientBrush);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, System.Drawing.SizeF*, System.Drawing.Size*, Common.PixelFormat*, CompatibleRenderTargetOptions, ID2D1BitmapRenderTarget**, int>)(lpVtbl[12]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), desiredSize, desiredPixelSize, desiredFormat, options, bitmapRenderTarget);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, System.Drawing.SizeF*, ID2D1Layer**, int>)(lpVtbl[13]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), size, layer);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, ID2D1Mesh**, int>)(lpVtbl[14]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), mesh);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, Vector2, Vector2, ID2D1Brush*, float, ID2D1StrokeStyle*, void>)(lpVtbl[15]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), point0, point1, brush, strokeWidth, strokeStyle);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, Vortice.Win32.Numerics.RectF*, ID2D1Brush*, float, ID2D1StrokeStyle*, void>)(lpVtbl[16]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), rect, brush, strokeWidth, strokeStyle);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, Vortice.Win32.Numerics.RectF*, ID2D1Brush*, void>)(lpVtbl[17]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), rect, brush);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, RoundedRect*, ID2D1Brush*, float, ID2D1StrokeStyle*, void>)(lpVtbl[18]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), roundedRect, brush, strokeWidth, strokeStyle);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, RoundedRect*, ID2D1Brush*, void>)(lpVtbl[19]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), roundedRect, brush);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, Ellipse*, ID2D1Brush*, float, ID2D1StrokeStyle*, void>)(lpVtbl[20]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), ellipse, brush, strokeWidth, strokeStyle);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, Ellipse*, ID2D1Brush*, void>)(lpVtbl[21]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), ellipse, brush);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, ID2D1Geometry*, ID2D1Brush*, float, ID2D1StrokeStyle*, void>)(lpVtbl[22]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), geometry, brush, strokeWidth, strokeStyle);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, ID2D1Geometry*, ID2D1Brush*, ID2D1Brush*, void>)(lpVtbl[23]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), geometry, brush, opacityBrush);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, ID2D1Mesh*, ID2D1Brush*, void>)(lpVtbl[24]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), mesh, brush);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, ID2D1Bitmap*, ID2D1Brush*, OpacityMaskContent, Vortice.Win32.Numerics.RectF*, Vortice.Win32.Numerics.RectF*, void>)(lpVtbl[25]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), opacityMask, brush, content, destinationRectangle, sourceRectangle);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, ID2D1Bitmap*, Vortice.Win32.Numerics.RectF*, float, BitmapInterpolationMode, Vortice.Win32.Numerics.RectF*, void>)(lpVtbl[26]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), bitmap, destinationRectangle, opacity, interpolationMode, sourceRectangle);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, Vector2, Graphics.DirectWrite.IDWriteTextLayout*, ID2D1Brush*, DrawTextOptions, void>)(lpVtbl[28]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), origin, textLayout, defaultFillBrush, options);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, Vector2, Graphics.DirectWrite.GlyphRun*, ID2D1Brush*, Graphics.DirectWrite.MeasuringMode, void>)(lpVtbl[29]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), baselineOrigin, glyphRun, foregroundBrush, measuringMode);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, Matrix3x2*, void>)(lpVtbl[30]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), transform);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, Matrix3x2*, void>)(lpVtbl[31]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), transform);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, AntialiasMode, void>)(lpVtbl[32]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), antialiasMode);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, AntialiasMode>)(lpVtbl[33]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this));
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, TextAntialiasMode, void>)(lpVtbl[34]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), textAntialiasMode);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, TextAntialiasMode>)(lpVtbl[35]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this));
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, ulong, ulong, void>)(lpVtbl[38]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), tag1, tag2);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, ulong*, ulong*, void>)(lpVtbl[39]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), tag1, tag2);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, LayerParameters*, ID2D1Layer*, void>)(lpVtbl[40]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), layerParameters, layer);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, void>)(lpVtbl[41]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this));
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, ulong*, ulong*, int>)(lpVtbl[42]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), tag1, tag2);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, ID2D1DrawingStateBlock*, void>)(lpVtbl[43]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), drawingStateBlock);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, ID2D1DrawingStateBlock*, void>)(lpVtbl[44]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), drawingStateBlock);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, Vortice.Win32.Numerics.RectF*, AntialiasMode, void>)(lpVtbl[45]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), clipRect, antialiasMode);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, void>)(lpVtbl[46]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this));
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, Color4*, void>)(lpVtbl[47]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), clearColor);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, void>)(lpVtbl[48]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this));
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, ulong*, ulong*, int>)(lpVtbl[49]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), tag1, tag2);
	}
	...
	public Common.PixelFormat GetPixelFormat()
	{
		...
		return *((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, Common.PixelFormat*, Common.PixelFormat*>)(lpVtbl[50]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), &result);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, float, float, void>)(lpVtbl[51]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), dpiX, dpiY);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, float*, float*, void>)(lpVtbl[52]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), dpiX, dpiY);
	}
	...
	public System.Drawing.SizeF GetSize()
	{
		...
		return *((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, System.Drawing.SizeF*, System.Drawing.SizeF*>)(lpVtbl[53]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), &result);
	}
	...
	public System.Drawing.Size GetPixelSize()
	{
		...
		return *((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, System.Drawing.Size*, System.Drawing.Size*>)(lpVtbl[54]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), &result);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, uint>)(lpVtbl[55]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this));
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, RenderTargetProperties*, Bool32>)(lpVtbl[56]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), renderTargetProperties);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, System.Drawing.Size, void*, uint, BitmapProperties1*, ID2D1Bitmap1**, int>)(lpVtbl[57]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), size, sourceData, pitch, bitmapProperties, bitmap);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, Graphics.Imaging.IWICBitmapSource*, BitmapProperties1*, ID2D1Bitmap1**, int>)(lpVtbl[58]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), wicBitmapSource, bitmapProperties, bitmap);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, ColorSpace, byte*, uint, ID2D1ColorContext**, int>)(lpVtbl[59]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), space, profile, profileSize, colorContext);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, Graphics.Dxgi.IDXGISurface*, BitmapProperties1*, ID2D1Bitmap1**, int>)(lpVtbl[62]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), surface, bitmapProperties, bitmap);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, Guid*, ID2D1Effect**, int>)(lpVtbl[63]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), effectId, effect);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, ID2D1Image*, ImageBrushProperties*, BrushProperties*, ID2D1ImageBrush**, int>)(lpVtbl[65]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), image, imageBrushProperties, brushProperties, imageBrush);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, ID2D1Bitmap*, BitmapBrushProperties1*, BrushProperties*, ID2D1BitmapBrush1**, int>)(lpVtbl[66]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), bitmap, bitmapBrushProperties, brushProperties, bitmapBrush);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, ID2D1CommandList**, int>)(lpVtbl[67]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), commandList);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, Graphics.Dxgi.Common.Format, Bool32>)(lpVtbl[68]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), format);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, BufferPrecision, Bool32>)(lpVtbl[69]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), bufferPrecision);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, ID2D1Image*, Vortice.Win32.Numerics.RectF**, int>)(lpVtbl[70]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), image, localBounds);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, ID2D1Image*, Vortice.Win32.Numerics.RectF**, int>)(lpVtbl[71]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), image, worldBounds);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, Vector2, Graphics.DirectWrite.GlyphRun*, Graphics.DirectWrite.MeasuringMode, Vortice.Win32.Numerics.RectF**, int>)(lpVtbl[72]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), baselineOrigin, glyphRun, measuringMode, bounds);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, ID2D1Device**, void>)(lpVtbl[73]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), device);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, ID2D1Image*, void>)(lpVtbl[74]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), image);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, ID2D1Image**, void>)(lpVtbl[75]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), image);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, RenderingControls*, void>)(lpVtbl[76]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), renderingControls);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, RenderingControls*, void>)(lpVtbl[77]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), renderingControls);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, PrimitiveBlend, void>)(lpVtbl[78]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), primitiveBlend);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, PrimitiveBlend>)(lpVtbl[79]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this));
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, UnitMode, void>)(lpVtbl[80]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), unitMode);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, UnitMode>)(lpVtbl[81]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this));
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, Vector2, Graphics.DirectWrite.GlyphRun*, Graphics.DirectWrite.GlyphRunDescription*, ID2D1Brush*, Graphics.DirectWrite.MeasuringMode, void>)(lpVtbl[82]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), baselineOrigin, glyphRun, glyphRunDescription, foregroundBrush, measuringMode);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, ID2D1Image*, Vector2*, Vortice.Win32.Numerics.RectF*, InterpolationMode, Common.CompositeMode, void>)(lpVtbl[83]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), image, targetOffset, imageRectangle, interpolationMode, compositeMode);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, ID2D1GdiMetafile*, Vector2*, void>)(lpVtbl[84]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), gdiMetafile, targetOffset);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, ID2D1Bitmap*, Vortice.Win32.Numerics.RectF*, float, InterpolationMode, Vortice.Win32.Numerics.RectF*, Matrix4x4*, void>)(lpVtbl[85]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), bitmap, destinationRectangle, opacity, interpolationMode, sourceRectangle, perspectiveTransform);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, LayerParameters1*, ID2D1Layer*, void>)(lpVtbl[86]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), layerParameters, layer);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, ID2D1Effect*, uint, Vortice.Win32.Numerics.RectF*, int>)(lpVtbl[87]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), effect, input, inputRectangle);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, ID2D1Effect*, uint*, int>)(lpVtbl[88]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), effect, rectangleCount);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, ID2D1Effect*, Vortice.Win32.Numerics.RectF**, uint, int>)(lpVtbl[89]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), effect, rectangles, rectanglesCount);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, ID2D1Effect*, Vortice.Win32.Numerics.RectF*, EffectInputDescription*, Vortice.Win32.Numerics.RectF**, uint, int>)(lpVtbl[90]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), renderEffect, renderImageRectangle, inputDescriptions, requiredInputRects, inputCount);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, ID2D1Bitmap*, ID2D1Brush*, Vortice.Win32.Numerics.RectF*, Vortice.Win32.Numerics.RectF*, void>)(lpVtbl[91]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), opacityMask, brush, destinationRectangle, sourceRectangle);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, ID2D1Geometry*, float, ID2D1GeometryRealization**, int>)(lpVtbl[92]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), geometry, flatteningTolerance, geometryRealization);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, ID2D1Geometry*, float, float, ID2D1StrokeStyle*, ID2D1GeometryRealization**, int>)(lpVtbl[93]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), geometry, flatteningTolerance, strokeWidth, strokeStyle, geometryRealization);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, ID2D1GeometryRealization*, ID2D1Brush*, void>)(lpVtbl[94]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), geometryRealization, brush);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, InkPoint*, ID2D1Ink**, int>)(lpVtbl[95]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), startPoint, ink);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, InkStyleProperties*, ID2D1InkStyle**, int>)(lpVtbl[96]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), inkStyleProperties, inkStyle);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, GradientMeshPatch*, uint, ID2D1GradientMesh**, int>)(lpVtbl[97]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), patches, patchesCount, gradientMesh);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, Graphics.Imaging.IWICBitmapSource*, ImageSourceLoadingOptions, Common.AlphaMode, ID2D1ImageSourceFromWic**, int>)(lpVtbl[98]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), wicBitmapSource, loadingOptions, alphaMode, imageSource);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, BufferPrecision, uint*, byte*, uint, uint*, ID2D1LookupTable3D**, int>)(lpVtbl[99]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), precision, extents, data, dataCount, strides, lookupTable);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, Graphics.Dxgi.IDXGISurface**, uint, Graphics.Dxgi.Common.ColorSpaceType, ImageSourceFromDxgiOptions, ID2D1ImageSource**, int>)(lpVtbl[100]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), surfaces, surfaceCount, colorSpace, options, imageSource);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, ID2D1GradientMesh*, Vortice.Win32.Numerics.RectF**, int>)(lpVtbl[101]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), gradientMesh, pBounds);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, ID2D1Ink*, ID2D1Brush*, ID2D1InkStyle*, void>)(lpVtbl[102]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), ink, brush, inkStyle);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, ID2D1GradientMesh*, void>)(lpVtbl[103]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), gradientMesh);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, ID2D1GdiMetafile*, Vortice.Win32.Numerics.RectF*, Vortice.Win32.Numerics.RectF*, void>)(lpVtbl[104]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), gdiMetafile, destinationRectangle, sourceRectangle);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, ID2D1ImageSource*, TransformedImageSourceProperties*, ID2D1TransformedImageSource**, int>)(lpVtbl[105]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), imageSource, properties, transformedImageSource);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, ID2D1SpriteBatch**, int>)(lpVtbl[106]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), spriteBatch);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, ID2D1SpriteBatch*, uint, uint, ID2D1Bitmap*, BitmapInterpolationMode, SpriteOptions, void>)(lpVtbl[107]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), spriteBatch, startIndex, spriteCount, bitmap, interpolationMode, spriteOptions);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, ID2D1SvgGlyphStyle**, int>)(lpVtbl[108]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), svgGlyphStyle);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, Vector2, Graphics.DirectWrite.IDWriteTextLayout*, ID2D1Brush*, ID2D1SvgGlyphStyle*, uint, DrawTextOptions, void>)(lpVtbl[110]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), origin, textLayout, defaultFillBrush, svgGlyphStyle, colorPaletteIndex, options);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, Graphics.DirectWrite.GlyphImageFormats, Vector2, Graphics.DirectWrite.GlyphRun*, Graphics.DirectWrite.MeasuringMode, ColorBitmapGlyphSnapOption, void>)(lpVtbl[111]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), glyphImageFormat, baselineOrigin, glyphRun, measuringMode, bitmapSnapOption);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext4*, Vector2, Graphics.DirectWrite.GlyphRun*, ID2D1Brush*, ID2D1SvgGlyphStyle*, uint, Graphics.DirectWrite.MeasuringMode, void>)(lpVtbl[112]))((ID2D1DeviceContext4*)Unsafe.AsPointer(ref this), baselineOrigin, glyphRun, defaultFillBrush, svgGlyphStyle, colorPaletteIndex, measuringMode);
	}
	...
	public interface Interface : ID2D1DeviceContext3.Interface
	{
		...
		[VtblIndex(109)]
		void DrawText(char* @string, uint stringLength, Graphics.DirectWrite.IDWriteTextFormat* textFormat, Vortice.Win32.Numerics.RectF* layoutRect, ID2D1Brush* defaultFillBrush, ID2D1SvgGlyphStyle* svgGlyphStyle, uint colorPaletteIndex, DrawTextOptions options, Graphics.DirectWrite.MeasuringMode measuringMode);
