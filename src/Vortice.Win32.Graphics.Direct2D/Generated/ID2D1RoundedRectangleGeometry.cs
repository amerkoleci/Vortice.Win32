...
public unsafe partial struct ID2D1RoundedRectangleGeometry : ID2D1RoundedRectangleGeometry.Interface, INativeGuid
{
	...
	public uint AddRef()
	{
		return ((delegate* unmanaged[MemberFunction]<ID2D1RoundedRectangleGeometry*, uint>)(lpVtbl[1]))((ID2D1RoundedRectangleGeometry*)Unsafe.AsPointer(ref this));
	}
	...
	public uint Release()
	{
		return ((delegate* unmanaged[MemberFunction]<ID2D1RoundedRectangleGeometry*, uint>)(lpVtbl[2]))((ID2D1RoundedRectangleGeometry*)Unsafe.AsPointer(ref this));
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID2D1RoundedRectangleGeometry*, ID2D1Factory**, void>)(lpVtbl[3]))((ID2D1RoundedRectangleGeometry*)Unsafe.AsPointer(ref this), factory);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID2D1RoundedRectangleGeometry*, ID2D1Geometry*, Matrix3x2*, float, GeometryRelation*, int>)(lpVtbl[8]))((ID2D1RoundedRectangleGeometry*)Unsafe.AsPointer(ref this), inputGeometry, inputGeometryTransform, flatteningTolerance, relation);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID2D1RoundedRectangleGeometry*, GeometrySimplificationOption, Matrix3x2*, float, Common.ID2D1SimplifiedGeometrySink*, int>)(lpVtbl[9]))((ID2D1RoundedRectangleGeometry*)Unsafe.AsPointer(ref this), simplificationOption, worldTransform, flatteningTolerance, geometrySink);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID2D1RoundedRectangleGeometry*, ID2D1Geometry*, CombineMode, Matrix3x2*, float, Common.ID2D1SimplifiedGeometrySink*, int>)(lpVtbl[11]))((ID2D1RoundedRectangleGeometry*)Unsafe.AsPointer(ref this), inputGeometry, combineMode, inputGeometryTransform, flatteningTolerance, geometrySink);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID2D1RoundedRectangleGeometry*, Matrix3x2*, float, Common.ID2D1SimplifiedGeometrySink*, int>)(lpVtbl[12]))((ID2D1RoundedRectangleGeometry*)Unsafe.AsPointer(ref this), worldTransform, flatteningTolerance, geometrySink);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID2D1RoundedRectangleGeometry*, float, ID2D1StrokeStyle*, Matrix3x2*, float, Common.ID2D1SimplifiedGeometrySink*, int>)(lpVtbl[16]))((ID2D1RoundedRectangleGeometry*)Unsafe.AsPointer(ref this), strokeWidth, strokeStyle, worldTransform, flatteningTolerance, geometrySink);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID2D1RoundedRectangleGeometry*, RoundedRect*, void>)(lpVtbl[17]))((ID2D1RoundedRectangleGeometry*)Unsafe.AsPointer(ref this), roundedRect);
	}
