...
public unsafe partial struct ID2D1Device7 : ID2D1Device7.Interface, INativeGuid
{
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID2D1Device7*, Guid*, void**, int>)(lpVtbl[0]))((ID2D1Device7*)Unsafe.AsPointer(ref this), riid, ppvObject);
	}
	...
	public uint AddRef()
	{
		return ((delegate* unmanaged[MemberFunction]<ID2D1Device7*, uint>)(lpVtbl[1]))((ID2D1Device7*)Unsafe.AsPointer(ref this));
	}
	...
	public uint Release()
	{
		return ((delegate* unmanaged[MemberFunction]<ID2D1Device7*, uint>)(lpVtbl[2]))((ID2D1Device7*)Unsafe.AsPointer(ref this));
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID2D1Device7*, ID2D1Factory**, void>)(lpVtbl[3]))((ID2D1Device7*)Unsafe.AsPointer(ref this), factory);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID2D1Device7*, ulong, void>)(lpVtbl[5]))((ID2D1Device7*)Unsafe.AsPointer(ref this), maximumInBytes);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID2D1Device7*, ulong>)(lpVtbl[6]))((ID2D1Device7*)Unsafe.AsPointer(ref this));
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID2D1Device7*, uint, void>)(lpVtbl[7]))((ID2D1Device7*)Unsafe.AsPointer(ref this), millisecondsSinceUse);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID2D1Device7*, ID2D1Bitmap*, void>)(lpVtbl[12]))((ID2D1Device7*)Unsafe.AsPointer(ref this), bitmap);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID2D1Device7*, Graphics.Dxgi.IDXGIDevice**, int>)(lpVtbl[13]))((ID2D1Device7*)Unsafe.AsPointer(ref this), dxgiDevice);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID2D1Device7*, ulong, void>)(lpVtbl[16]))((ID2D1Device7*)Unsafe.AsPointer(ref this), maximumInBytes);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID2D1Device7*, ulong>)(lpVtbl[17]))((ID2D1Device7*)Unsafe.AsPointer(ref this));
	}
