...
public unsafe partial struct ID2D1CommandSink5 : ID2D1CommandSink5.Interface, INativeGuid
{
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID2D1CommandSink5*, Vortice.Win32.Numerics.RectF*, ID2D1Brush*, float, ID2D1StrokeStyle*, int>)(lpVtbl[16]))((ID2D1CommandSink5*)Unsafe.AsPointer(ref this), rect, brush, strokeWidth, strokeStyle);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID2D1CommandSink5*, ID2D1Bitmap*, ID2D1Brush*, Vortice.Win32.Numerics.RectF*, Vortice.Win32.Numerics.RectF*, int>)(lpVtbl[21]))((ID2D1CommandSink5*)Unsafe.AsPointer(ref this), opacityMask, brush, destinationRectangle, sourceRectangle);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID2D1CommandSink5*, Vortice.Win32.Numerics.RectF*, ID2D1Brush*, int>)(lpVtbl[23]))((ID2D1CommandSink5*)Unsafe.AsPointer(ref this), rect, brush);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID2D1CommandSink5*, ID2D1GdiMetafile*, Vortice.Win32.Numerics.RectF*, Vortice.Win32.Numerics.RectF*, int>)(lpVtbl[31]))((ID2D1CommandSink5*)Unsafe.AsPointer(ref this), gdiMetafile, destinationRectangle, sourceRectangle);
	}
