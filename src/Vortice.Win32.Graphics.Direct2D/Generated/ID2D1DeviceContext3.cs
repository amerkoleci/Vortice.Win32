...
public unsafe partial struct ID2D1DeviceContext3 : ID2D1DeviceContext3.Interface, INativeGuid
{
	...
	{
		((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext3*, Vortice.Win32.Numerics.RectF*, ID2D1Brush*, float, ID2D1StrokeStyle*, void>)(lpVtbl[16]))((ID2D1DeviceContext3*)Unsafe.AsPointer(ref this), rect, brush, strokeWidth, strokeStyle);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext3*, Vortice.Win32.Numerics.RectF*, ID2D1Brush*, void>)(lpVtbl[17]))((ID2D1DeviceContext3*)Unsafe.AsPointer(ref this), rect, brush);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext3*, ID2D1Image*, Vortice.Win32.Numerics.RectF**, int>)(lpVtbl[70]))((ID2D1DeviceContext3*)Unsafe.AsPointer(ref this), image, localBounds);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext3*, ID2D1Image*, Vortice.Win32.Numerics.RectF**, int>)(lpVtbl[71]))((ID2D1DeviceContext3*)Unsafe.AsPointer(ref this), image, worldBounds);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext3*, ID2D1Effect*, uint, Vortice.Win32.Numerics.RectF*, int>)(lpVtbl[87]))((ID2D1DeviceContext3*)Unsafe.AsPointer(ref this), effect, input, inputRectangle);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext3*, ID2D1Effect*, Vortice.Win32.Numerics.RectF**, uint, int>)(lpVtbl[89]))((ID2D1DeviceContext3*)Unsafe.AsPointer(ref this), effect, rectangles, rectanglesCount);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext3*, ID2D1Bitmap*, ID2D1Brush*, Vortice.Win32.Numerics.RectF*, Vortice.Win32.Numerics.RectF*, void>)(lpVtbl[91]))((ID2D1DeviceContext3*)Unsafe.AsPointer(ref this), opacityMask, brush, destinationRectangle, sourceRectangle);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext3*, ID2D1GradientMesh*, Vortice.Win32.Numerics.RectF**, int>)(lpVtbl[101]))((ID2D1DeviceContext3*)Unsafe.AsPointer(ref this), gradientMesh, pBounds);
	}
	...
	{
		((delegate* unmanaged[MemberFunction]<ID2D1DeviceContext3*, ID2D1GdiMetafile*, Vortice.Win32.Numerics.RectF*, Vortice.Win32.Numerics.RectF*, void>)(lpVtbl[104]))((ID2D1DeviceContext3*)Unsafe.AsPointer(ref this), gdiMetafile, destinationRectangle, sourceRectangle);
	}
