...
public unsafe partial struct ID2D1Factory3 : ID2D1Factory3.Interface, INativeGuid
{
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID2D1Factory3*, Vortice.Win32.Numerics.RectF*, ID2D1RectangleGeometry**, int>)(lpVtbl[5]))((ID2D1Factory3*)Unsafe.AsPointer(ref this), rectangle, rectangleGeometry);
	}
