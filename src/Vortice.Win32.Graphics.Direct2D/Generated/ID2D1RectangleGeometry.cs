...
public unsafe partial struct ID2D1RectangleGeometry : ID2D1RectangleGeometry.Interface, INativeGuid
{
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID2D1RectangleGeometry*, Matrix3x2*, Vortice.Win32.Numerics.RectF**, int>)(lpVtbl[4]))((ID2D1RectangleGeometry*)Unsafe.AsPointer(ref this), worldTransform, bounds);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID2D1RectangleGeometry*, float, ID2D1StrokeStyle*, Matrix3x2*, float, Vortice.Win32.Numerics.RectF**, int>)(lpVtbl[5]))((ID2D1RectangleGeometry*)Unsafe.AsPointer(ref this), strokeWidth, strokeStyle, worldTransform, flatteningTolerance, bounds);
	}
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	[VtblIndex(17)]
	public void GetRect(Vortice.Win32.Numerics.RectF** rect)
	{
		((delegate* unmanaged[MemberFunction]<ID2D1RectangleGeometry*, Vortice.Win32.Numerics.RectF**, void>)(lpVtbl[17]))((ID2D1RectangleGeometry*)Unsafe.AsPointer(ref this), rect);
	}

	public interface Interface : ID2D1Geometry.Interface
	{
		[VtblIndex(17)]
		void GetRect(Vortice.Win32.Numerics.RectF** rect);
	}
}
