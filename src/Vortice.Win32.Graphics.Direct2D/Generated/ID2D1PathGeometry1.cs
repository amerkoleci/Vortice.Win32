...
public unsafe partial struct ID2D1PathGeometry1 : ID2D1PathGeometry1.Interface, INativeGuid
{
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID2D1PathGeometry1*, Matrix3x2*, Vortice.Win32.Numerics.RectF**, int>)(lpVtbl[4]))((ID2D1PathGeometry1*)Unsafe.AsPointer(ref this), worldTransform, bounds);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID2D1PathGeometry1*, float, ID2D1StrokeStyle*, Matrix3x2*, float, Vortice.Win32.Numerics.RectF**, int>)(lpVtbl[5]))((ID2D1PathGeometry1*)Unsafe.AsPointer(ref this), strokeWidth, strokeStyle, worldTransform, flatteningTolerance, bounds);
	}
