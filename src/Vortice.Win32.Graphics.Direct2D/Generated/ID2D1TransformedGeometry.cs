...
public unsafe partial struct ID2D1TransformedGeometry : ID2D1TransformedGeometry.Interface, INativeGuid
{
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID2D1TransformedGeometry*, Matrix3x2*, Vortice.Win32.Numerics.RectF**, int>)(lpVtbl[4]))((ID2D1TransformedGeometry*)Unsafe.AsPointer(ref this), worldTransform, bounds);
	}
	...
	{
		return ((delegate* unmanaged[MemberFunction]<ID2D1TransformedGeometry*, float, ID2D1StrokeStyle*, Matrix3x2*, float, Vortice.Win32.Numerics.RectF**, int>)(lpVtbl[5]))((ID2D1TransformedGeometry*)Unsafe.AsPointer(ref this), strokeWidth, strokeStyle, worldTransform, flatteningTolerance, bounds);
	}
