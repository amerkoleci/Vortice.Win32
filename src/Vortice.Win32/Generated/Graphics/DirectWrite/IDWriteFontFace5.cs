...
public unsafe partial struct IDWriteFontFace5
{
	...
	{
		return ((delegate* unmanaged[Stdcall]<IDWriteFontFace5*, uint, uint, uint, Win32.Graphics.Direct2D.Common.ColorF**, int>)(lpVtbl[33]))((IDWriteFontFace5*)Unsafe.AsPointer(ref this), colorPaletteIndex, firstEntryIndex, entryCount, paletteEntries);
	}
