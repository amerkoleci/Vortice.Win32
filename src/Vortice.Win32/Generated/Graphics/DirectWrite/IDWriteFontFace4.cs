...
public unsafe partial struct IDWriteFontFace4
{
	...
	{
		return ((delegate* unmanaged[Stdcall]<IDWriteFontFace4*, uint, uint, uint, Win32.Graphics.Direct2D.Common.ColorF**, int>)(lpVtbl[33]))((IDWriteFontFace4*)Unsafe.AsPointer(ref this), colorPaletteIndex, firstEntryIndex, entryCount, paletteEntries);
	}
