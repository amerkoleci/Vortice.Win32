...
public unsafe partial struct IDWriteFontFace6
{
	...
	{
		return ((delegate* unmanaged[Stdcall]<IDWriteFontFace6*, uint, uint, uint, Win32.Graphics.Direct2D.Common.ColorF**, int>)(lpVtbl[33]))((IDWriteFontFace6*)Unsafe.AsPointer(ref this), colorPaletteIndex, firstEntryIndex, entryCount, paletteEntries);
	}
