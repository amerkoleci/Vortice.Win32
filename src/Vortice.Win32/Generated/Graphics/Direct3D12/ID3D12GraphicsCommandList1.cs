...
public unsafe partial struct ID3D12GraphicsCommandList1
{
	...
	{
		((delegate* unmanaged[Stdcall]<ID3D12GraphicsCommandList1*, uint, RawRect*, void>)(lpVtbl[22]))((ID3D12GraphicsCommandList1*)Unsafe.AsPointer(ref this), NumRects, pRects);
	}
