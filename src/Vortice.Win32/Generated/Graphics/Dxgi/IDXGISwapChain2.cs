...
public unsafe partial struct IDXGISwapChain2
{
	...
	{
		return ((delegate* unmanaged[Stdcall]<IDXGISwapChain2*, Rgba*, int>)(lpVtbl[25]))((IDXGISwapChain2*)Unsafe.AsPointer(ref this), pColor);
	}
	...
	{
		return ((delegate* unmanaged[Stdcall]<IDXGISwapChain2*, Rgba*, int>)(lpVtbl[26]))((IDXGISwapChain2*)Unsafe.AsPointer(ref this), pColor);
	}
