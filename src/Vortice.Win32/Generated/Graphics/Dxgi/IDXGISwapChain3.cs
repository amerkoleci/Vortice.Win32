...
public unsafe partial struct IDXGISwapChain3
{
	...
	{
		return ((delegate* unmanaged[Stdcall]<IDXGISwapChain3*, Rgba*, int>)(lpVtbl[25]))((IDXGISwapChain3*)Unsafe.AsPointer(ref this), pColor);
	}
	...
	{
		return ((delegate* unmanaged[Stdcall]<IDXGISwapChain3*, Rgba*, int>)(lpVtbl[26]))((IDXGISwapChain3*)Unsafe.AsPointer(ref this), pColor);
	}
